...
.method private handleSimLoaded(I)V
    ...
    const-string v14, "handleSimStateLoadedInternal: slotId: "
    ...
    .line 362
    sget-object v13, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mPhone:[Lcom/android/internal/telephony/Phone;
    ...
    .line 364
    const-string v13, "onRecieve: IccRecords null"
    ...
    .line 368
    const-string v13, "onRecieve: IccID null"
    ...
    .line 373
    sget-object v13, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mTelephonyMgr:Landroid/telephony/TelephonyManager;
    ...
    sput-object v13, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mTelephonyMgr:Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual {v13, v0}, Lcom/android/internal/telephony/SubscriptionController;->getSubId(I)[I
    ...
    invoke-virtual {v13}, Lcom/android/internal/telephony/SubscriptionController;->getDefaultSubId()I
    ...
    invoke-static {v13, v7, v14}, Lcom/android/internal/telephony/MccTable;->updateMccMncConfiguration(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v13, v7, v10}, Lcom/android/internal/telephony/SubscriptionController;->setMccMnc(Ljava/lang/String;I)I
    ...
    invoke-virtual {v13, v10}, Landroid/telephony/TelephonyManager;->getLine1NumberForSubscriber(I)Ljava/lang/String;
    ...
    .line 399
    .local v6, "number":Landroid/content/ContentValues;
    ...
    invoke-virtual {v1, v13, v6, v14, v15}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I

    .line 405
    .end local v6    # "number":Landroid/content/ContentValues;
    :cond_6
    move-object/from16 v0, p0
    ...
    invoke-virtual {v13, v10}, Landroid/telephony/SubscriptionManager;->getActiveSubscriptionInfo(I)Landroid/telephony/SubscriptionInfo;
    ...
    invoke-virtual {v13, v10}, Landroid/telephony/TelephonyManager;->getSimOperatorNameForSubscription(I)Ljava/lang/String;
    ...
    invoke-virtual {v13, v14}, Landroid/telephony/TelephonyManager;->getSubscriberId(I)Ljava/lang/String;
    ...
    invoke-static {v13, v9, v2, v14, v0}, Lcom/android/internal/telephony/SubscriptionController;->getCarrierName(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v13, v4, v14, v15}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .end local v5    # "nameToSet":Ljava/lang/String;
    .end local v9    # "simCarrierName":Ljava/lang/String;
    .end local v12    # "subInfo":Landroid/telephony/SubscriptionInfo;
    :cond_7
    const-string v13, "EVENT_RECORDS_LOADED Operator name is null"
    ...
    :cond_8
    const-string v13, "Invalid subId, could not update ContentResolver"

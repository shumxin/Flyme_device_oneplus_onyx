...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 74
    iput-boolean v1, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mIsRuim:Z
...
.method public colorGetIccCardType()Ljava/lang/String;
    ...
    .line 807
    :cond_0
    iget-boolean v1, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mIsRuim:Z
...
.method public oppoGetSimPhonebookNameLength()I
    ...
    .line 683
    iget-boolean v4, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->phonebookReady:Z

    if-nez v4, :cond_0

    .line 688
    const-string v4, "oppoGetSimPhonebookNameLength phone book is not ready return default len 14"
    ...
    .line 700
    :try_start_0
    iget v5, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->simNameLeng:I
    ...
    invoke-virtual {v5, v6, v0}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->oppoGetADNFieldsInfo(ILandroid/os/Message;)V
    ...
    .line 710
    iget v4, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->simNameLeng:I
...
.method public oppoUpdateAdnRecordsWithContentValuesInEfBySearch(ILandroid/content/ContentValues;Ljava/lang/String;)I
    ...
    .line 830
    .local v24, "oldTag":Ljava/lang/String;
    ...
    .line 832
    .local v23, "oldPhoneNumber":Ljava/lang/String;
    ...
    .line 836
    .local v19, "oldAnr":Ljava/lang/String;
    ...
    .line 838
    .local v22, "oldEmailArray":[Ljava/lang/String;
    :goto_0
    ...
    .line 839
    .local v16, "newEmailArray":[Ljava/lang/String;
    :goto_1
    ...
    .line 840
    .local v20, "oldAnrArray":[Ljava/lang/String;
    :goto_2
    ...
    const-string v5, "oppoUpdateAdnRecordsWithContentValuesInEfBySearch: efid="
    ...
    .line 860
    .local v26, "status":Ljava/util/concurrent/atomic/AtomicBoolean;
    move-object/from16 v0, p0
    ...
    invoke-direct {v7, v0, v1, v2, v14}, Lcom/android/internal/telephony/uicc/AdnRecord;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual/range {v4 .. v11}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->oppoUpdateAdnBySearchEx(ILcom/android/internal/telephony/uicc/AdnRecord;Lcom/android/internal/telephony/uicc/AdnRecord;Ljava/lang/String;Landroid/os/Message;ILjava/lang/String;)I
    ...
    const-string v5, "update adn not success,return index = "
    ...
    .end local v16    # "newEmailArray":[Ljava/lang/String;
    .end local v20    # "oldAnrArray":[Ljava/lang/String;
    .end local v22    # "oldEmailArray":[Ljava/lang/String;
    .end local v25    # "sid":Ljava/lang/String;
    .end local v26    # "status":Ljava/util/concurrent/atomic/AtomicBoolean;
    :cond_3
    move-object/from16 v0, p0
    ...
    .line 838
    .restart local v22    # "oldEmailArray":[Ljava/lang/String;
    :cond_4
    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->getStringArray(Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 839
    .restart local v16    # "newEmailArray":[Ljava/lang/String;
    :cond_5
    move-object/from16 v0, p0
    ...
    .line 840
    .restart local v20    # "oldAnrArray":[Ljava/lang/String;
    :cond_6
    move-object/from16 v0, p0

    invoke-direct {v0, v13}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->getAnrStringArray(Ljava/lang/String;)[Ljava/lang/String;
    ...
    .restart local v25    # "sid":Ljava/lang/String;
    .restart local v26    # "status":Ljava/util/concurrent/atomic/AtomicBoolean;
    :cond_7
    :try_start_1
...
.method public setIccCard(Lcom/android/internal/telephony/uicc/UiccCard;)V
    ...
    .line 244
    iput-boolean v8, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mIsRuim:Z

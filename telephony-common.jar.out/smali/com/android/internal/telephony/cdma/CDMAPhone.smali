...
.method public dial(Ljava/lang/String;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
    ...
    const-string v7, "IMS call UT enable exception "
    ...
    invoke-virtual {p0, p1, v5, p2}, Lcom/android/internal/telephony/cdma/CDMAPhone;->dialInternal(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;I)Lcom/android/internal/telephony/Connection;
...
.method public getPOLTotleNumber()I
    ...
    .line 2057
    .local v0, "mSIMRecords":Lcom/android/internal/telephony/uicc/RuimRecords;
    const-string v2, "yangli"

    const-string v3, "getPOLTotleNumber enter ====================="
    ...
    .end local v0    # "mSIMRecords":Lcom/android/internal/telephony/uicc/RuimRecords;
    check-cast v0, Lcom/android/internal/telephony/uicc/RuimRecords;

    .line 2060
    .restart local v0    # "mSIMRecords":Lcom/android/internal/telephony/uicc/RuimRecords;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/uicc/RuimRecords;->getPOLTotleNumber()I
    ...
    const-string v3, "mSIMRecords is null ====================="
...
.method public getPOLUsedNumber()I
    ...
    const-string v3, "getPOLUsedNumber enter ====================="
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/uicc/RuimRecords;->getPOLUsedNumber()I
...
.method public getPreferedOperatorList(Landroid/os/Message;)V
    ...
    const-string v2, "getPreferedOperatorList enter ====================="
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/internal/telephony/uicc/RuimRecords;->getPreferedOperatorList(Landroid/os/Message;Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;)V

    .line 2024
    const-string v1, "yangli"

    const-string v2, "getPreferedOperatorList ok level ====================="
    ...
    const-string v2, "mSIMRecords is null ====================="
    ...
    const-string v2, "mIccRecords is null ====================="
...
.method protected init(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;)V
    ...
    .line 175
    new-instance v4, Lcom/android/internal/telephony/cdma/OppoCdmaCallTracker;

    invoke-direct {v4, p0}, Lcom/android/internal/telephony/cdma/OppoCdmaCallTracker;-><init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
...
.method public setPOLEntry(Lcom/android/internal/telephony/cdma/CdmaNetworkInfoWithAcT;Landroid/os/Message;)V
    ...
    const-string v2, "setPOLEntry enter ====================="
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/internal/telephony/uicc/RuimRecords;->setPOLEntry(Lcom/android/internal/telephony/cdma/CdmaNetworkInfoWithAcT;Landroid/os/Message;)V

    .line 2043
    const-string v1, "yangli"

    const-string v2, "setPOLEntry ok  ====================="

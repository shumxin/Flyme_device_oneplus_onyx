...
.field private mLastUSBStatus:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 143
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->mLastUSBStatus:Z
...
.method private processValuesLocked(Z)V
    ...
    .line 435
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mLastUSBStatus:Z

    if-nez v0, :cond_1

    .line 436
    const-string v0, "sys.is_charger_present"
    ...
    iput-boolean v0, p0, Lcom/android/server/BatteryService;->mLastUSBStatus:Z
...
.method private updateBatteryLedColors()V
    ...
    iput v1, p0, Lcom/android/server/BatteryService;->mBatteryLowARGB:I
    ...
    iput v1, p0, Lcom/android/server/BatteryService;->mBatteryMediumARGB:I
    ...
    iput v1, p0, Lcom/android/server/BatteryService;->mBatteryFullARGB:I

    iget-object v1, p0, Lcom/android/server/BatteryService;->mLed:Lcom/android/server/BatteryService$Led;
...
.method public onBootPhase(I)V
    ...
    invoke-direct {v3, p0, v5}, Lcom/android/server/BatteryService$1;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V
    ...
    const-string v8, "battery_led_low_power"

    invoke-direct {v7, p0, v1, v8}, Lcom/android/server/BatteryService$2;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;Ljava/lang/String;)V

    aput-object v7, v2, v5

    const/4 v5, 0x1

    new-instance v7, Lcom/android/server/BatteryService$3;

    const-string v8, "battery_led_charging"

    invoke-direct {v7, p0, v1, v8}, Lcom/android/server/BatteryService$3;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, v5}, Lcom/android/server/BatteryService$4;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V

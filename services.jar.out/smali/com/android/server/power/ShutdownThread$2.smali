...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/server/power/ShutdownThread;->stopTopApplication(Landroid/content/Context;)V
.end annotation
...
.method public run()V
    ...
    .line 337
    iget-object v6, p0, Lcom/android/server/power/ShutdownThread$2;->val$context:Landroid/content/Context;
    ...
    .line 341
    .local v1, "apps":Ljava/util/List;, "Ljava/util/List<Landroid/app/ActivityManager$RecentTaskInfo;>;"
    ...
    .line 343
    .local v5, "topApp":Landroid/app/ActivityManager$RecentTaskInfo;
    ...
    iget-object v7, p0, Lcom/android/server/power/ShutdownThread$2;->val$context:Landroid/content/Context;

    invoke-virtual {v7}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v7

    invoke-virtual {v6, v7, v8}, Landroid/content/Intent;->resolveActivityInfo(Landroid/content/pm/PackageManager;I)Landroid/content/pm/ActivityInfo;
    ...
    const-string v8, "force stop package "
    ...
    .end local v5    # "topApp":Landroid/app/ActivityManager$RecentTaskInfo;
    :cond_1
    return-void
.end method

...
.method private final deliverToRegisteredReceiverLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;Z)V
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/android/server/AppOpsService;->noteOperation(IILjava/lang/String;)I
    ...
    const-string v5, " not allowed for broadcast to uid "
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/am/OppoProcessManagerHelper;->skipBroadcast(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-direct {v0, v3, v1, v4}, Lcom/android/server/am/BroadcastQueue;->oppoSetProcReceive(ZLcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/am/ActivityManagerService;->updateOomAdjLocked(Lcom/android/server/am/ProcessRecord;)Z
    ...
    iget-boolean v9, v0, Lcom/android/server/am/BroadcastRecord;->ordered:Z

    move-object/from16 v0, p1

    iget-boolean v10, v0, Lcom/android/server/am/BroadcastRecord;->initialSticky:Z
    ...
    iput-object v4, v3, Lcom/android/server/am/ReceiverList;->curBroadcast:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v3, v3, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v4, v4, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;

    iput-object v4, v3, Lcom/android/server/am/ProcessRecord;->curReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v3, v3, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v4, v4, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;
...
.method private oppoProcessBroadcastFinish(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    .locals 8
    ...
    .line 1577
    iget-object v0, p1, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;

    if-eqz v0, :cond_1

    iget-object v0, p1, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;

    iget-object v0, v0, Lcom/android/server/am/BroadcastRecord;->queue:Lcom/android/server/am/BroadcastQueue;
    ...
    const-string v2, "finish broadcast app.foreCurReceiver = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p1, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    .line 1581
    iget-object v1, p1, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v4, v0, Lcom/android/server/am/BroadcastRecord;->resultExtras:Landroid/os/Bundle;

    iget-object v0, p1, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;

    iget-boolean v5, v0, Lcom/android/server/am/BroadcastRecord;->resultAbort:Z
    ...
    .line 1586
    :cond_1
    iget-object v0, p1, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    const-string v2, "finish broadcast app.backReceiver = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p1, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    .line 1590
    iget-object v1, p1, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
...
.method private oppoSetProcReceive(ZLcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    .locals 3
    .param p1, "flag"    # Z
    .param p2, "r"    # Lcom/android/server/am/BroadcastRecord;
    ...
    .line 1561
    iput-object p2, p3, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    .line 1563
    :cond_0
    iput-object p2, p3, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    .line 1567
    iput-object v2, p3, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;

    goto :goto_0

    .line 1569
    :cond_2
    iput-object v2, p3, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
...
.method private final processCurBroadcastLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v2, "processCurBroadcastLocked app.thread "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p2, Lcom/android/server/am/ProcessRecord;->thread:Landroid/app/IApplicationThread;
    ...
    const-string v2, "processCurBroadcastLocked thread.getName() "
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/android/server/am/BroadcastQueue;->oppoSetProcReceive(ZLcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    .line 280
    :cond_3
    invoke-static {p0, p2, p1}, Lcom/android/server/am/OppoProcessManagerHelper;->checkBroadcast(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    .line 306
    iget-object v0, p2, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    .line 307
    iget-object v0, p2, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;

    iput-object v0, p2, Lcom/android/server/am/ProcessRecord;->curReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    iput-object v1, p1, Lcom/android/server/am/BroadcastRecord;->curApp:Lcom/android/server/am/ProcessRecord;

    .line 306
    iget-object v1, p2, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;

    if-eqz v1, :cond_c

    iget-object v1, p2, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;

    iget-object v1, v1, Lcom/android/server/am/BroadcastRecord;->queue:Lcom/android/server/am/BroadcastQueue;

    if-ne v1, p0, :cond_c

    .line 307
    iget-object v1, p2, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;

    iput-object v1, p2, Lcom/android/server/am/ProcessRecord;->curReceiver:Lcom/android/server/am/BroadcastRecord;

    .line 317
    :goto_1
    const/4 v1, 0x0

    invoke-direct {p0, v1, p1, p2}, Lcom/android/server/am/BroadcastQueue;->oppoSetProcReceive(ZLcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
...
.method final broadcastTimeoutLocked(Z)V
    ...
    const-string v7, "Timeout of broadcast1111 "
    ...
    .line 1378
    invoke-static {v12}, Lcom/android/server/am/OppoProcessManagerHelper;->checkProcessWhileBroadcastTimeout(Lcom/android/server/am/ProcessRecord;)Z
...
.method public finishReceiverLocked(Lcom/android/server/am/BroadcastRecord;ILjava/lang/String;Landroid/os/Bundle;ZZ)Z
    ...
    const-string v6, "finishReceiverLocked : mQueueName = "
    ...
    invoke-virtual {p1}, Lcom/android/server/am/BroadcastRecord;->toString()Ljava/lang/String;
    ...
    const-string v6, " r.curApp.foreCurReceiver "
    ...
    iget-object v6, v6, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, " r.curApp.backCurReceiver "
    ...
    iget-object v6, v6, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    iget-object v5, v5, Lcom/android/server/am/ProcessRecord;->backCurReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-direct {p0, v4, p1, v5}, Lcom/android/server/am/BroadcastQueue;->oppoSetProcReceive(ZLcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-object v5, v5, Lcom/android/server/am/ProcessRecord;->foreCurReceiver:Lcom/android/server/am/BroadcastRecord;
...
.method public isPendingBroadcastProcessLocked(I)Z
    ...
    const-string v2, " mPendingBroadcast = "
...
.method final processNextBroadcast(Z)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "ZhiYong.Lin@Plf.Framework, modify for BPMliumei@Plf.Framework, 2013/12/04:Modify for autostart manager"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    .line 739
    .local v38, "thread":Ljava/lang/Thread;
    const-string v4, "BroadcastQueue"
    ...
    const-string v7, "processNextBroadcast thread.getName() "
    ...
    .line 742
    .end local v38    # "thread":Ljava/lang/Thread;
    :cond_0
    move-object/from16 v0, p0
    ...
    const-string v6, "No more broadcasts pending, so all done!"
    ...
    const-string v7, "Hung broadcast 2222222["
    ...
    const-string v7, "] print the time :"
    ...
    const-string v7, "  siganl use time = "
    ...
    const-string v7, " nextReceiver index = "
    ...
    const-string v7, "nextReceiver instanceof BroadcastFilter = "
    ...
    instance-of v7, v0, Lcom/android/server/am/BroadcastFilter;
    ...
    invoke-virtual {v4, v6}, Lcom/android/server/am/OppoAbnormalAppManager;->validNewProc(Ljava/lang/String;)Z
    ...
    const-string v7, " : package is restricted"
    ...
    invoke-virtual {v4, v6, v7}, Lcom/android/server/am/OppoAppStartupManager;->handleSpecialBroadcast(Landroid/content/Intent;Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/am/OppoAutostartManager;->checkAutoBootForbiddenStart(Lcom/android/server/am/BroadcastQueue;Landroid/content/pm/ResolveInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/am/OppoProcessManagerHelper;->checkBroadcastIsPackageCanStart(Lcom/android/server/am/BroadcastQueue;Landroid/content/pm/ResolveInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    const-string v7, "mPendingBroadcast curApp = "
...
.method public sendPendingBroadcastsLocked(Lcom/android/server/am/ProcessRecord;)Z
    ...
    const-string v3, " sendPendingBroadcastsLocked mPendingBroadcast = "
...
.method public skipCurrentReceiverLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v3, "skipCurrentReceiverLocked : mQueueName = "
    ...
    .line 393
    invoke-direct {p0, p1, v1}, Lcom/android/server/am/BroadcastQueue;->oppoProcessBroadcastFinish(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
...
.method public skipPendingBroadcastLocked(I)V
    ...
    const-string v3, " skipPendingBroadcastLocked mPendingBroadcast = "

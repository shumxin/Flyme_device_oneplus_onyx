...
.method static synthetic access$1500(Lcom/android/server/BluetoothManagerService;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 68
    invoke-direct {p0, p1}, Lcom/android/server/BluetoothManagerService;->tryResumeProcess(I)Z
...
.method private sendBluetoothServiceDownCallback()V
    ...
    invoke-virtual {v5}, Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;->isGetNameAddressOnly()Z
    ...
    const-string v6, "Calling onBluetoothServiceDown callbacks"
    ...
    const-string v7, "Broadcasting onBluetoothServiceDown() to "
    ...
    invoke-direct {p0, v5}, Lcom/android/server/BluetoothManagerService;->tryResumeProcess(I)Z
    ...
    invoke-interface {v5}, Landroid/bluetooth/IBluetoothManagerCallback;->onBluetoothServiceDown()V
    ...
    .line 911
    .restart local v3    # "pid":Ljava/lang/Integer;
    :cond_0
    const-string v5, "BluetoothManagerService"
    ...
    const-string v7, "sendBluetoothServiceDownCallback() resume failed, don\'t call back!!! i = "
    ...
    const-string v7, "Unable to call onBluetoothServiceDown() on callback #"
...
.method private sendBluetoothServiceUpCallback()V
    ...
    const-string v6, "Calling onBluetoothServiceUp callbacks"
    ...
    const-string v7, "Broadcasting onBluetoothServiceUp() to "
    ...
    invoke-interface {v5, v6}, Landroid/bluetooth/IBluetoothManagerCallback;->onBluetoothServiceUp(Landroid/bluetooth/IBluetooth;)V
    ...
    const-string v7, "sendBluetoothServiceUpCallback() resume failed, don\'t call back!!! i = "
    ...
    const-string v7, "Unable to call onBluetoothServiceUp() on callback #"
...
.method private sendBluetoothStateCallback(Z)V
    ...
    const-string v7, "Broadcasting onBluetoothStateChange("
    ...
    invoke-interface {v5, p1}, Landroid/bluetooth/IBluetoothStateChangeCallback;->onBluetoothStateChange(Z)V
    ...
    const-string v7, "sendBluetoothStateCallback() resume failed, don\'t call back!!! i = "
    ...
    const-string v7, "Unable to call onBluetoothStateChange() on callback #"
    ...
    const-string v7, "Unable to call sendBluetoothStateCallback() on callback #"
...
.method private tryResumeProcess(I)Z
    .locals 6
    .param p1, "pid"    # I
    ...
    .line 1825
    .local v0, "count":I
    invoke-static {p1}, Landroid/os/Process;->isProcessSuspend(I)Z
    ...
    const-string v5, "tryResumeProcess() count = "
    ...
    const-string v4, "tryResumeProcess() failed count = "

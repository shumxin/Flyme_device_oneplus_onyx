...
# static fields
.field static final ATTACH_STATE_BEGIN:I = 0x1

.field static final ATTACH_STATE_END:I = 0x2

.field static final ATTACH_STATE_NOTDEFINE:I = 0x0
...
.field mAttachState:I

.field mAttachSuccess:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/wm/WindowState;->DEBUG_CONFIGURATION:Z

    .line 86
    sget-boolean v0, Lcom/android/server/wm/WindowManagerService;->DEBUG_LAYOUT:Z

    sput-boolean v0, Lcom/android/server/wm/WindowState;->DEBUG_LAYOUT:Z

    .line 87
    sget-boolean v0, Lcom/android/server/wm/WindowManagerService;->DEBUG_ORIENTATION:Z

    sput-boolean v0, Lcom/android/server/wm/WindowState;->DEBUG_ORIENTATION:Z

    .line 88
    sget-boolean v0, Lcom/android/server/wm/WindowManagerService;->DEBUG_RESIZE:Z

    sput-boolean v0, Lcom/android/server/wm/WindowState;->DEBUG_RESIZE:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    iput-boolean v10, p0, Lcom/android/server/wm/WindowState;->mAttachSuccess:Z

    .line 369
    const/4 v10, 0x0

    iput v10, p0, Lcom/android/server/wm/WindowState;->mAttachState:I
...
.method attach()V
    ...
    .line 520
    :cond_0
    iput v3, p0, Lcom/android/server/wm/WindowState;->mAttachState:I

    .line 521
    iput-boolean v3, p0, Lcom/android/server/wm/WindowState;->mAttachSuccess:Z
    ...
    iput v0, p0, Lcom/android/server/wm/WindowState;->mAttachState:I
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    .line 1564
    .local v0, "isAppAnimationNull":Z
    :goto_1
    invoke-virtual {p1, p2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string v2, " mAppToken.mAppAnimator.animation null ? "
    ...
    .line 1574
    .end local v0    # "isAppAnimationNull":Z
    :goto_2
    iget-object v2, p0, Lcom/android/server/wm/WindowState;->mTargetAppToken:Lcom/android/server/wm/AppWindowToken;
    ...
    const-string v2, "mAppToken=null"
...
.method hideLw(ZZ)Z
    ...
    .line 1287
    :cond_6
    sget-boolean v3, Lcom/android/server/wm/WindowState;->DEBUG_VISIBILITY:Z
...
.method isAttachSuccess()Z
    .locals 1

    .prologue
    .line 1516
    iget-boolean v0, p0, Lcom/android/server/wm/WindowState;->mAttachSuccess:Z
...
.method removeLocked()V
    ...
    const-string v3, "windowState.removeLocked unlinkToDeath failed. windowState:"
...
.method reportResized()V
    ...
    .line 1434
    :try_start_0
    sget-boolean v0, Lcom/android/server/wm/WindowState;->DEBUG_RESIZE:Z

    if-nez v0, :cond_0

    sget-boolean v0, Lcom/android/server/wm/WindowState;->DEBUG_ORIENTATION:Z
    ...
    sget-boolean v0, Lcom/android/server/wm/WindowState;->DEBUG_CONFIGURATION:Z

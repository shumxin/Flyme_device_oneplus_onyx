...
.field private static final MONITORING_CERT_NOTIFICATION_ID:I = 0x10400f5
...
.method updateUserSetupComplete()V
    ...
    invoke-static {v5, v8, v10, v6}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 5455
    .local v4, "policy":Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;
    iget-boolean v8, v4, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mUserSetupComplete:Z

    if-nez v8, :cond_0

    .line 5456
    iput-boolean v9, v4, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mUserSetupComplete:Z
    ...
    .end local v1    # "googleSetup":Z
    .end local v3    # "oneplusSetup":Z
    :cond_1
    move v1, v10
    ...
    .line 5451
    .restart local v1    # "googleSetup":Z
    :cond_2
    const-string v8, "user_setup_complete_oneplus"
    ...
    .line 5459
    .restart local v3    # "oneplusSetup":Z

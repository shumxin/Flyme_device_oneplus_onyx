...
.field mIcsExt:Landroid/net/wifi/cmcc/ConnectivityServiceExt;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iput-object v3, v0, Lcom/android/server/ConnectivityService;->mIcsExt:Landroid/net/wifi/cmcc/ConnectivityServiceExt;
    ...
    iput-boolean v3, v0, Lcom/android/server/ConnectivityService;->bManualConnect:Z
    ...
    iput-object v3, v0, Lcom/android/server/ConnectivityService;->mManualReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 640
    .local v17, "handlerThread":Landroid/os/HandlerThread;
    ...
    .line 657
    .local v14, "dns":Ljava/lang/String;
    if-eqz v14, :cond_1
    ...
    const-string v4, "connectivity_release_pending_intent_delay_ms"
    ...
    iput v3, v0, Lcom/android/server/ConnectivityService;->mReleasePendingIntentDelayMs:I
    ...
    .line 672
    const-string v3, "missing INetworkStatsService"
    ...
    iput-object v3, v0, Lcom/android/server/ConnectivityService;->mStatsService:Landroid/net/INetworkStatsService;
    ...
    iput-object v3, v0, Lcom/android/server/ConnectivityService;->mPendingIntentWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    const-string v3, "android.net.wifi.CONNECT_MODE_CHANGE"

    invoke-direct {v10, v3}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 766
    .local v10, "manualFilter":Landroid/content/IntentFilter;
    move-object/from16 v0, p0
    ...
    iget-object v8, v0, Lcom/android/server/ConnectivityService;->mManualReceiver:Landroid/content/BroadcastReceiver;
    ...
    .end local v10    # "manualFilter":Landroid/content/IntentFilter;
    ...
    .restart local v10    # "manualFilter":Landroid/content/IntentFilter;
    :catch_3
    move-exception v15
...
.method static synthetic access$4700(Lcom/android/server/ConnectivityService;)Z
    ...
    .prologue
    .line 170
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->bManualConnect:Z
...
.method static synthetic access$4702(Lcom/android/server/ConnectivityService;Z)Z
    ...
    .prologue
    .line 170
    iput-boolean p1, p0, Lcom/android/server/ConnectivityService;->bManualConnect:Z
...
.method private getUnfilteredActiveNetworkState(I)Landroid/net/NetworkState;
    ...
    iget-object v1, v11, Lcom/android/server/connectivity/NetworkAgentInfo;->linkProperties:Landroid/net/LinkProperties;

    invoke-direct {v10, v1}, Landroid/net/LinkProperties;-><init>(Landroid/net/LinkProperties;)V
    :try_end_2
    ...
    :try_start_3
    new-instance v12, Landroid/net/NetworkCapabilities;
    ...
    invoke-direct {v12, v1}, Landroid/net/NetworkCapabilities;-><init>(Landroid/net/NetworkCapabilities;)V
    :try_end_3
    ...
    :try_start_4
    new-instance v13, Landroid/net/Network;

    iget-object v1, v11, Lcom/android/server/connectivity/NetworkAgentInfo;->network:Landroid/net/Network;

    invoke-direct {v13, v1}, Landroid/net/Network;-><init>(Landroid/net/Network;)V
    :try_end_4
    ...
    .line 905
    .end local v14    # "networks":[Landroid/net/Network;
    :catch_0
    move-exception v8
    ...
    iget-object v7, v0, Lcom/android/server/ConnectivityService;->mNetworkForRequestId:Landroid/util/SparseArray;

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/server/ConnectivityService;->mDefaultRequest:Landroid/net/NetworkRequest;

    iget v15, v15, Landroid/net/NetworkRequest;->requestId:I
    ...
    .restart local v14    # "networks":[Landroid/net/Network;
    :cond_2
    const/4 v11, 0x0
    ...
    .restart local v12    # "nc":Landroid/net/NetworkCapabilities;
...
.method private setProvNotificationVisibleIntent(ZIILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    iget-boolean v14, v0, Lcom/android/server/ConnectivityService;->bManualConnect:Z
    ...
    invoke-virtual {v14, v15}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->getNetworkForType(I)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    .line 3293
    .local v4, "captiveIntent":Landroid/content/Intent;
    ...
    iget-object v15, v8, Lcom/android/server/connectivity/NetworkAgentInfo;->network:Landroid/net/Network;
    ...
    const-string v15, "com.android.captiveportallogin"

    const-string v16, "com.android.captiveportallogin.CaptivePortalLoginActivity"
    ...
    const-string v15, "setProvNotificationVisibleIntent: manual connect, start CaptivePortalLoginActivity"
    ...
    invoke-virtual {v14, v4, v15}, Landroid/content/Context;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    :try_end_0
    ...
    const-string v16, "ActivityNotFoundException "
    ...
    .line 3311
    .end local v4    # "captiveIntent":Landroid/content/Intent;
    ...
    const-string v15, "setProvNotificationVisibleIntent: E visible="
    ...
    iget-object v15, v9, Landroid/app/Notification;->contentIntent:Landroid/app/PendingIntent;

    invoke-virtual {v9, v14, v13, v5, v15}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    .line 3388
    :try_start_1
    const-string v14, "CaptivePortal.Notification"

    move/from16 v0, p2

    invoke-virtual {v10, v14, v0, v9}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
    :try_end_1
    .catch Ljava/lang/NullPointerException; {:try_start_1 .. :try_end_1} :catch_1

    .line 3407
    .end local v5    # "details":Ljava/lang/CharSequence;
    .end local v7    # "icon":I
    ...
    iput-boolean v0, v1, Lcom/android/server/ConnectivityService;->mIsNotificationVisible:Z
    ...
    .line 3329
    .restart local v5    # "details":Ljava/lang/CharSequence;
    const v7, 0x1080659
    ...
    invoke-virtual {v14, v13}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v14

    invoke-virtual {v14, v5}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    iget-object v14, v0, Lcom/android/server/ConnectivityService;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    iput v14, v9, Landroid/app/Notification;->color:I
    ...
    :cond_3
    :try_start_2
    const-string v14, "notify:ConnectivityManager.TYPE_WIFI != networkType"
    ...
    const-string v15, "setNotificaitionVisible: visible notificationManager npe="
    ...
    const-string v15, "setNotificaitionVisible: cancel notificationManager npe="
...
.method private updateMtu(Landroid/net/LinkProperties;Landroid/net/LinkProperties;)V
    ...
    .line 1775
    const-string v3, "persist.sys.oppo.mtu"
...
.method systemReady()V
    ...
    .line 1652
    const-string v2, "Init IConnectivityServiceExt class"

    invoke-static {v2}, Lcom/android/server/ConnectivityService;->log(Ljava/lang/String;)V

    .line 1653
    new-instance v2, Landroid/net/wifi/cmcc/ConnectivityServiceExt;

    invoke-direct {v2}, Landroid/net/wifi/cmcc/ConnectivityServiceExt;-><init>()V

    iput-object v2, p0, Lcom/android/server/ConnectivityService;->mIcsExt:Landroid/net/wifi/cmcc/ConnectivityServiceExt;

    .line 1654
    iget-object v2, p0, Lcom/android/server/ConnectivityService;->mIcsExt:Landroid/net/wifi/cmcc/ConnectivityServiceExt;

    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mContext:Landroid/content/Context;

    invoke-virtual {v2, v3}, Landroid/net/wifi/cmcc/ConnectivityServiceExt;->init(Landroid/content/Context;)V

...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/backup/Trampoline;)V
    ...
    .line 973
    .local v15, "oneplusProvisioned":Z
    :goto_1
    if-eqz v9, :cond_9
    ...
    invoke-direct {v13, v8}, Ljava/io/DataInputStream;-><init>(Ljava/io/InputStream;)V
    :try_end_1
    ...
    .line 1095
    .local v10, "hosts":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .line 1103
    .local v19, "transport":Landroid/content/pm/ServiceInfo;
    move-object/from16 v0, p0
    ...
    .end local v6    # "filter":Landroid/content/IntentFilter;
    .end local v9    # "googleProvisioned":Z
    .end local v10    # "hosts":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v11    # "i":I
    .end local v14    # "initIntent":Landroid/content/Intent;
    .end local v15    # "oneplusProvisioned":Z
    .end local v19    # "transport":Landroid/content/pm/ServiceInfo;
    :cond_6
    const/4 v9, 0x0
    ...
    .line 971
    .restart local v9    # "googleProvisioned":Z
    :cond_7
    move-object/from16 v0, p0
    ...
    const-string v21, "device_provisioned_oneplus"
    ...
    .line 973
    .restart local v15    # "oneplusProvisioned":Z
    :cond_9
    const/16 v20, 0x0
    ...
    .line 984
    :cond_b
    const-string v20, "device_provisioned_oneplus"
    ...
    .line 1095
    .restart local v10    # "hosts":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    :cond_12
    invoke-interface {v10}, Ljava/util/List;->size()I

...
.method public constructor <init>(Landroid/content/Context;Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayBlanker;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/display/DisplayPowerController;->useProximityForceSuspend:Z
    ...
    iput-object v2, v0, Lcom/android/server/display/DisplayPowerController;->mOnProximityPositiveSuspendRunnable:Ljava/lang/Runnable;
    ...
    iput-object v2, v0, Lcom/android/server/display/DisplayPowerController;->mOnProximityNegativeSuspendRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {v14, v2, v3, v4}, Landroid/content/res/Resources;->getFraction(III)F
    ...
    sput-boolean v2, Lcom/android/server/display/DisplayPowerController;->DEBUG_PANIC:Z
    ...
    iget-object v5, v0, Lcom/android/server/display/DisplayPowerController;->mContext:Landroid/content/Context;
    ...
    invoke-direct/range {v2 .. v11}, Lcom/android/server/display/AutomaticBrightnessController;-><init>(Lcom/android/server/display/AutomaticBrightnessController$Callbacks;Landroid/os/Looper;Landroid/content/Context;Landroid/hardware/SensorManager;Landroid/util/Spline;IIIF)V
...
.method private updatePowerState()V
    ...
    const-string v13, "useProximityForceSuspend = "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-boolean v13, p0, Lcom/android/server/display/DisplayPowerController;->useProximityForceSuspend:Z
    ...
    .line 602
    iget-boolean v11, p0, Lcom/android/server/display/DisplayPowerController;->useProximityForceSuspend:Z
    ...
    .line 606
    iget-boolean v11, p0, Lcom/android/server/display/DisplayPowerController;->mProximityEventHandled:Z
    ...
    .line 609
    invoke-direct {p0}, Lcom/android/server/display/DisplayPowerController;->sendOnProximityPositiveSuspendWithWakelock()V
    ...
    iput-boolean v11, p0, Lcom/android/server/display/DisplayPowerController;->mProximityEventHandled:Z
    ...
    sput-boolean v11, Lcom/android/server/display/DisplayPowerController;->mScreenDimQuicklyDark:Z
    ...
    .line 819
    :cond_1c
    sget-boolean v11, Lcom/android/server/display/DisplayPowerController;->DEBUG_PANIC:Z
    ...
    const-string v13, "updatePowerState: state = "
    ...
    const-string v13, "mColorFadeOffAnimator.isStarted() : "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-object v13, p0, Lcom/android/server/display/DisplayPowerController;->mColorFadeOffAnimator:Landroid/animation/ObjectAnimator;
    ...
    .line 611
    invoke-direct {p0}, Lcom/android/server/display/DisplayPowerController;->sendOnProximityNegativeSuspendWithWakelock()V
    ...
    const-string v12, "the last proximity event has been handled"
    ...
    .line 624
    :cond_27
    iget-boolean v11, p0, Lcom/android/server/display/DisplayPowerController;->mProximitySensorEnabled:Z
    ...
    const-string v13, "mPowerRequest.useProximitySensor = "
    ...
    iget-boolean v13, p0, Lcom/android/server/display/DisplayPowerController;->mWaitingForNegativeProximity:Z
    ...
    const-string v12, "turn on lcd light due to proximity released"

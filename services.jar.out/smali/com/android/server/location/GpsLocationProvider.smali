...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/location/GpsLocationProvider$GpsController;,
...
.field private static final INDOOR_MODE_DISABLE_ACTION:Ljava/lang/String; = "android.intent.action.GPS_INDOOR_MODE_DISABLE"
...
.field private static final SUPL_HOST_CN_DEFAULT:Ljava/lang/String; = "supl.nokia.com"

.field private static final SUPL_HOST_US_DEFAULT:Ljava/lang/String; = "supl.google.com"
...
.field private mDisableGpsIndoorMode:Z
...
.field private mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 282
    iput-object v5, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;

    .line 283
    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/location/GpsLocationProvider;->mSpeed:F

    .line 287
    iput-boolean v3, p0, Lcom/android/server/location/GpsLocationProvider;->mDisableGpsIndoorMode:Z
    ...
    .line 831
    const-string v0, "supl.nokia.com"
...
.method private AgpsTimeZoneChangedHandler(Landroid/content/Intent;)V
    .locals 4
    ...
    .line 478
    const-string v1, "supl.nokia.com"
...
.method static synthetic access$1000(Lcom/android/server/location/GpsLocationProvider;)Lcom/android/server/location/GpsLocationProvider$GpsController;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;

    .prologue
    .line 114
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;

    return-object v0
.end method

.method static synthetic access$1002(Lcom/android/server/location/GpsLocationProvider;Lcom/android/server/location/GpsLocationProvider$GpsController;)Lcom/android/server/location/GpsLocationProvider$GpsController;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # Lcom/android/server/location/GpsLocationProvider$GpsController;

    .prologue
    .line 114
    iput-object p1, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;
...
.method static synthetic access$1100(Lcom/android/server/location/GpsLocationProvider;Landroid/content/Intent;)V
    ...
    .prologue
    .line 114
    invoke-direct {p0, p1}, Lcom/android/server/location/GpsLocationProvider;->AgpsTimeZoneChangedHandler(Landroid/content/Intent;)V
...
.method static synthetic access$2300(Lcom/android/server/location/GpsLocationProvider;JJI)V
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # J
    .param p3, "x2"    # J
...
.method static synthetic access$2400(Lcom/android/server/location/GpsLocationProvider;IILjava/lang/Object;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$3000(IDDDIIII)Z
    .locals 1
    .param p0, "x0"    # I
    .param p1, "x1"    # D
    .param p3, "x2"    # D
...
.method static synthetic access$3700(Lcom/android/server/location/GpsLocationProvider;Lcom/android/internal/location/ProviderRequest;Landroid/os/WorkSource;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3800(Lcom/android/server/location/GpsLocationProvider;ILandroid/net/NetworkInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # I
...
.method static synthetic access$4400(Lcom/android/server/location/GpsLocationProvider;Landroid/location/Location;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4500(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4502(Lcom/android/server/location/GpsLocationProvider;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4600(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$5300(Lcom/android/server/location/GpsLocationProvider;)F
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;

    .prologue
    .line 114
    iget v0, p0, Lcom/android/server/location/GpsLocationProvider;->mSpeed:F

    return v0
.end method

.method static synthetic access$5400(Lcom/android/server/location/GpsLocationProvider;)[F
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$6100(Lcom/android/server/location/GpsLocationProvider;)Landroid/location/ILocationManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$902(Lcom/android/server/location/GpsLocationProvider;Z)Z
    ...
    .prologue
    .line 114
    iput-boolean p1, p0, Lcom/android/server/location/GpsLocationProvider;->mDisableGpsIndoorMode:Z
...
.method private handleDisable()V
    ...
    invoke-virtual {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->tearDown()V

    .line 1287
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;

    invoke-virtual {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->stopNavigatingNotify()V

    .line 1288
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;

    invoke-virtual {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->stopController()V
...
.method private listenForBroadcasts()V
    ...
    .line 945
    const-string v3, "android.intent.action.GPS_INDOOR_MODE_DISABLE"
...
.method private native native_setdebug_log(I)I
.end method
...
.method private startNavigating(Z)V
    ...
    .line 1607
    :cond_6
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mDisableGpsIndoorMode:Z
    ...
    .line 1609
    new-instance v0, Lcom/android/server/location/GpsLocationProvider$GpsController;

    invoke-direct {v0, p0}, Lcom/android/server/location/GpsLocationProvider$GpsController;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;

    .line 1610
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;

    invoke-virtual {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->setUp()V

    .line 1612
    :cond_7
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;

    invoke-virtual {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->startController()V
...
.method private testMccMncConfigurable(Landroid/content/Context;)Z
    ...
    invoke-virtual {v9, v13}, Landroid/telephony/TelephonyManager;->getNetworkOperatorForSubscription(I)Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v7, v13}, Ljava/util/Vector;->add(Ljava/lang/Object;)Z
    ...
    const-string v13, "assisted_gps_configurable_list"
...
.method private updateRequirements()V
    ...
    invoke-virtual {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->resistStartGps()Z
    ...
    .line 1389
    iput-boolean v8, p0, Lcom/android/server/location/GpsLocationProvider;->mSingleShot:Z
...
.method public enableVerboseLogging(I)V
    ...
    :goto_1
    sput-boolean v2, Lcom/android/server/location/GpsLocationProvider;->VERBOSE:Z
    ...
    invoke-direct {p0, v1}, Lcom/android/server/location/GpsLocationProvider;->native_setdebug_log(I)I

    .line 2470
    :goto_2
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsController:Lcom/android/server/location/GpsLocationProvider$GpsController;
    ...
    invoke-virtual {v1}, Lcom/android/server/location/GpsLocationProvider$GpsController;->getGpsMonitor()Lcom/android/server/location/GpsMonitor;

    move-result-object v0

    .line 2472
    .local v0, "gpsMonitor":Lcom/android/server/location/GpsMonitor;
    if-eqz v0, :cond_0
    ...
    .line 2479
    .end local v0    # "gpsMonitor":Lcom/android/server/location/GpsMonitor;
    :cond_0
    :goto_3
    return-void
    ...
    const-string v2, "mGpsController == null  "

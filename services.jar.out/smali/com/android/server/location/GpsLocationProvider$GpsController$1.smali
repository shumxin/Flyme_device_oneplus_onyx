...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->access$4900(Lcom/android/server/location/GpsLocationProvider$GpsController;)V
    ...
    invoke-static {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->access$5000(Lcom/android/server/location/GpsLocationProvider$GpsController;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/location/GpsLocationProvider$GpsController;->access$5102(Lcom/android/server/location/GpsLocationProvider$GpsController;I)I

    .line 2966
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider$GpsController$1;->this$1:Lcom/android/server/location/GpsLocationProvider$GpsController;

    # invokes: Lcom/android/server/location/GpsLocationProvider$GpsController;->enterPowerSavingMode()V
    invoke-static {v0}, Lcom/android/server/location/GpsLocationProvider$GpsController;->access$5200(Lcom/android/server/location/GpsLocationProvider$GpsController;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GpsLocationProvider;->access$5300(Lcom/android/server/location/GpsLocationProvider;)F
    ...
    invoke-static {v2}, Lcom/android/server/location/GpsLocationProvider;->access$5400(Lcom/android/server/location/GpsLocationProvider;)[F

    move-result-object v2

    # invokes: Lcom/android/server/location/GpsLocationProvider$GpsController;->changeGpsMode(F[F)V
    invoke-static {v0, v1, v2}, Lcom/android/server/location/GpsLocationProvider$GpsController;->access$5500(Lcom/android/server/location/GpsLocationProvider$GpsController;F[F)V

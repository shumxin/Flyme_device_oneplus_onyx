...
.method private increaseBackoffSetting(Lcom/android/server/content/SyncOperation;)V
    ...
    const-string v14, "current backoff is "
    ...
    const-string v14, "current backoff delay time is "
    ...
    const-string v14, "Still in backoff, do not increase it. Remaining: "
    ...
    .line 944
    .end local v6    # "newDelayInMs":J
    :cond_2
    const-string v2, "SyncManager"

    const-string v3, "previousSettings is NULL"
    ...
    .line 961
    .restart local v6    # "newDelayInMs":J
    :cond_3
    ...
    .line 981
    .local v10, "maxSyncRetryTimeInSeconds":J
    if-eqz v8, :cond_6
    ...
    iget-object v14, v0, Lcom/android/server/content/SyncOperation;->target:Lcom/android/server/content/SyncStorageEngine$EndPoint;

    invoke-virtual {v2, v14, v4, v5}, Lcom/android/server/content/SyncQueue;->onBackoffChanged(Lcom/android/server/content/SyncStorageEngine$EndPoint;J)V

...
.method public enter()V
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$24100(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0, v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$23502(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$23500(Lcom/android/server/wifi/WifiStateMachine;)J
    ...
    iget-boolean v0, v0, Lcom/android/server/wifi/WifiStateMachine;->shouldWifiStayAwake:Z
    ...
    invoke-static {v0, v1, v8, v8}, Lcom/android/server/wifi/WifiStateMachine;->access$22600(Lcom/android/server/wifi/WifiStateMachine;ILandroid/net/wifi/ScanSettings;Landroid/os/WorkSource;)V
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$24304(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0, v7}, Lcom/android/server/wifi/WifiStateMachine;->access$21600(Lcom/android/server/wifi/WifiStateMachine;Z)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    # ++operator for: Lcom/android/server/wifi/WifiStateMachine;->mPeriodicScanToken:I
    invoke-static {v4}, Lcom/android/server/wifi/WifiStateMachine;->access$24304(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->access$24700(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/wifi/WifiStateMachine;->access$19400(Lcom/android/server/wifi/WifiStateMachine;Landroid/os/Message;)Z
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mDisconnectedScanPeriodMs:I
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$24200(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/server/wifi/WifiStateMachine;->access$19600(Lcom/android/server/wifi/WifiStateMachine;IZILandroid/net/wifi/ScanSettings;Landroid/os/WorkSource;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->access$24502(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    # invokes: Lcom/android/server/wifi/WifiStateMachine;->startDelayedScan(ILandroid/net/wifi/ScanSettings;Landroid/os/WorkSource;)V
    invoke-static {v0, v1, v2, v4}, Lcom/android/server/wifi/WifiStateMachine;->access$22600(Lcom/android/server/wifi/WifiStateMachine;ILandroid/net/wifi/ScanSettings;Landroid/os/WorkSource;)V

...
.method private sendClientsChangedBroadcast()V
    ...
    const-string v1, "HotspotClientNum"

    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mClientNum:I
    invoke-static {}, Lcom/android/server/wifi/WifiStateMachine;->access$29000()I
...
.method public enter()V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$29002(I)I

    .line 9630
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mHotspotClients:Ljava/util/HashMap;
    invoke-static {}, Lcom/android/server/wifi/WifiStateMachine;->access$30300()Ljava/util/HashMap;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    iget-object v8, v4, Lcom/android/server/wifi/WifiStateMachine$TetherStateChange;->active:Ljava/util/ArrayList;

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->isWifiTethered(Ljava/util/ArrayList;)Z
    invoke-static {v7, v8}, Lcom/android/server/wifi/WifiStateMachine;->access$29700(Lcom/android/server/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    ...
    invoke-virtual {v7, v10, v5}, Lcom/android/server/wifi/WifiStateMachine;->setHostApRunning(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    invoke-virtual {v5, v10, v6}, Lcom/android/server/wifi/WifiStateMachine;->setHostApRunning(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$30400(Lcom/android/server/wifi/WifiStateMachine;)V
    ...
    invoke-static {v7}, Lcom/android/server/wifi/WifiStateMachine;->access$30500(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v7

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v7}, Lcom/android/server/wifi/WifiStateMachine;->access$30600(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V

    .line 9655
    iget-object v5, p0, Lcom/android/server/wifi/WifiStateMachine$TetheredState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->deferMessage(Landroid/os/Message;)V
    invoke-static {v5, p1}, Lcom/android/server/wifi/WifiStateMachine;->access$30700(Lcom/android/server/wifi/WifiStateMachine;Landroid/os/Message;)V
    ...
    invoke-static {}, Lcom/android/server/wifi/WifiStateMachine;->access$29004()I
    ...
    iget-object v9, v1, Landroid/net/wifi/HotspotClient;->deviceAddress:Ljava/lang/String;
    ...
    .line 9684
    # --operator for: Lcom/android/server/wifi/WifiStateMachine;->mClientNum:I
    invoke-static {}, Lcom/android/server/wifi/WifiStateMachine;->access$29006()I
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$3900(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiNative;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$30800(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/AsyncChannel;

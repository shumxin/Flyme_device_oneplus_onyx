...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiNative;)V
    ...
    .line 474
    iput-object v3, p0, Lcom/android/server/wifi/WifiConfigStore;->mWifiAutoConnect:Landroid/net/wifi/cmcc/WifiAutoConnectOP01;
    ...
    iput-object v0, p0, Lcom/android/server/wifi/WifiConfigStore;->mWifiAutoConnect:Landroid/net/wifi/cmcc/WifiAutoConnectOP01;
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    const-string v28, "failed to set PIN: "
    ...
    const-string v28, "failed to set PCSC: "
    ...
    const-string v28, "failed to set sim_num: "
...
.method private oppoEnableAllNetworks()V
    ...
    .line 4764
    iget-object v4, p0, Lcom/android/server/wifi/WifiConfigStore;->mWifiAutoConnect:Landroid/net/wifi/cmcc/WifiAutoConnectOP01;
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/server/wifi/WifiNative;->enableNetwork(IZ)Z
...
.method private readNetworkVariables(Landroid/net/wifi/WifiConfiguration;)V
    ...
    iput-object v12, v0, Landroid/net/wifi/WifiConfiguration;->IMSI:Ljava/lang/String;
    ...
    iput-object v12, v0, Landroid/net/wifi/WifiConfiguration;->SIMSLOT:Ljava/lang/String;
    ...
    iput-object v12, v0, Landroid/net/wifi/WifiConfiguration;->PIN:Ljava/lang/String;
    ...
    iput-object v12, v0, Landroid/net/wifi/WifiConfiguration;->PCSC:Ljava/lang/String;
    ...
    iput v13, v0, Landroid/net/wifi/WifiConfiguration;->sim_num:I
    ...
    iput-object v13, v0, Landroid/net/wifi/WifiConfiguration;->IMSI:Ljava/lang/String;
    ...
    iput-object v13, v0, Landroid/net/wifi/WifiConfiguration;->SIMSLOT:Ljava/lang/String;
    ...
    iput-object v13, v0, Landroid/net/wifi/WifiConfiguration;->PIN:Ljava/lang/String;
    ...
    iput-object v13, v0, Landroid/net/wifi/WifiConfiguration;->PCSC:Ljava/lang/String;
...
.method public associateWithConfiguration(Landroid/net/wifi/ScanResult;)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-virtual {v14, v12, v2}, Ljava/lang/String;->replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v23

    .line 3458
    .local v23, "resultSecurity":Ljava/lang/String;
    move-object/from16 v0, v20
    ...
    .line 3459
    .local v21, "linkSecurity":Ljava/lang/String;
    :goto_2
    if-eqz v23, :cond_9
    ...
    const-string v3, "associateWithConfiguration(): do not link "
    ...
    .line 3458
    .end local v21    # "linkSecurity":Ljava/lang/String;
    :cond_8
    const/16 v21, 0x0
    ...
    .line 3465
    .restart local v21    # "linkSecurity":Ljava/lang/String;
    :cond_9
    invoke-virtual/range {v20 .. v20}, Landroid/net/wifi/WifiConfiguration;->configKey()Ljava/lang/String;
    ...
    .line 3509
    .local v22, "psk":Ljava/lang/String;
    if-eqz v22, :cond_14
    ...
    .line 3536
    .end local v22    # "psk":Ljava/lang/String;
    :cond_12
    :goto_3
    if-eqz v13, :cond_16
    ...
    .end local v21    # "linkSecurity":Ljava/lang/String;
    .end local v23    # "resultSecurity":Ljava/lang/String;
    :cond_13
    ...
    .restart local v21    # "linkSecurity":Ljava/lang/String;
    .restart local v22    # "psk":Ljava/lang/String;
    .restart local v23    # "resultSecurity":Ljava/lang/String;
    :cond_14
    const/4 v13, 0x0
...
.method enableAllNetworks()V
    ...
    .line 788
    invoke-direct {p0}, Lcom/android/server/wifi/WifiConfigStore;->oppoEnableAllNetworks()V
...
.method handleSSIDStateChange(IZLjava/lang/String;Ljava/lang/String;)V
    ...
    .line 4487
    const-string v4, "tyl enableAllNetworks for NO_CREDENTIALS"
...
.method public updateSavedNetworkHistory(Landroid/net/wifi/ScanResult;)Z
    ...
    .line 3634
    :cond_2
    sget-boolean v20, Lcom/android/server/wifi/WifiConfigStore;->VVDBG:Z
    ...
    const-string v21, "updateSavedNetworkHistory(): SSID mismatch "
    ...
    .line 3640
    :cond_3
    sget-boolean v20, Lcom/android/server/wifi/WifiConfigStore;->VDBG:Z
    ...
    const-string v21, "updateSavedNetworkHistory(): try "
    ...
    .line 3650
    .local v17, "resultConfigKey":Ljava/lang/String;
    new-instance v20, Ljava/lang/StringBuilder;
    ...
    .line 3651
    .local v18, "resultSecurity":Ljava/lang/String;
    invoke-virtual {v5}, Landroid/net/wifi/WifiConfiguration;->configKey()Ljava/lang/String;
    ...
    .line 3652
    .local v6, "configSecurity":Ljava/lang/String;
    if-eqz v18, :cond_5
    ...
    const-string v21, "updateSavedNetworkHistory(): do not associate "
    ...
    const-string v21, "updateSavedNetworkHistory(): found a deleted, skip it...  "
    ...
    const-string v21, " Will trim config "
    ...
    iget v0, v0, Landroid/net/wifi/ScanResult;->numConnection:I
    ...
    const-string v21, " Finished trimming config, time(ns) "
    ...
    .line 3754
    .restart local v15    # "r":Landroid/net/wifi/ScanResult;
    new-instance v20, Ljava/lang/StringBuilder;
    ...
    const-string v21, "        got known scan result "
    ...
    .line 3779
    .end local v5    # "config":Landroid/net/wifi/WifiConfiguration;
    .end local v6    # "configSecurity":Ljava/lang/String;
    .end local v7    # "found":Z
    .end local v17    # "resultConfigKey":Ljava/lang/String;
    .end local v18    # "resultSecurity":Ljava/lang/String;

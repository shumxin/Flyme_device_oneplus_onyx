...
.field private static final IsCustomizeAbiSelection:Z = true
...
.field private static sChangeABI:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/content/NativeLibraryHelper;->sChangeABI:I
...
.method public static copyNativeBinariesForSupportedAbi(Lcom/android/internal/content/NativeLibraryHelper$Handle;Ljava/io/File;[Ljava/lang/String;Z)I
    ...
    .line 358
    invoke-static {p0, p2, v9}, Lcom/android/internal/content/NativeLibraryHelper;->findSupportedAbi(Lcom/android/internal/content/NativeLibraryHelper$Handle;[Ljava/lang/String;Z)I
    ...
    .end local v2    # "i":I
    :cond_2
    sget v7, Lcom/android/internal/content/NativeLibraryHelper;->sChangeABI:I

    if-ltz v7, :cond_3

    .line 372
    sget v0, Lcom/android/internal/content/NativeLibraryHelper;->sChangeABI:I
    ...
    .line 385
    .local v4, "isaSubdir":Ljava/io/File;
    invoke-static {v4}, Lcom/android/internal/content/NativeLibraryHelper;->createNativeLibrarySubdir(Ljava/io/File;)V

    .line 386
    move-object v6, v4

    .line 390
    .end local v4    # "isaSubdir":Ljava/io/File;
    .local v6, "subDir":Ljava/io/File;
    :goto_2
    aget-object v7, p2, v5

    invoke-static {p0, v6, v7}, Lcom/android/internal/content/NativeLibraryHelper;->copyNativeBinaries(Lcom/android/internal/content/NativeLibraryHelper$Handle;Ljava/io/File;Ljava/lang/String;)I
    ...
    .line 401
    .restart local v4    # "isaSubdir":Ljava/io/File;
    invoke-static {v4}, Lcom/android/internal/content/NativeLibraryHelper;->createNativeLibrarySubdir(Ljava/io/File;)V
    ...
    .line 407
    .end local v4    # "isaSubdir":Ljava/io/File;
    .restart local v6    # "subDir":Ljava/io/File;
    :goto_3
    aget-object v7, p2, v0
...
.method public static customizeAbiSelection(IZ)V
    .locals 0
    .param p0, "changeABI"    # I
    .param p1, "mBootCompleted"    # Z

    .prologue
    .line 534
    sput p0, Lcom/android/internal/content/NativeLibraryHelper;->sChangeABI:I
...
.method public static findSupportedAbi(Lcom/android/internal/content/NativeLibraryHelper$Handle;[Ljava/lang/String;)I
    ...
    invoke-static {p0, p1, v0}, Lcom/android/internal/content/NativeLibraryHelper;->findSupportedAbi(Lcom/android/internal/content/NativeLibraryHelper$Handle;[Ljava/lang/String;Z)I
...
.method public static findSupportedAbi(Lcom/android/internal/content/NativeLibraryHelper$Handle;[Ljava/lang/String;Z)I
    .locals 11
    .param p0, "handle"    # Lcom/android/internal/content/NativeLibraryHelper$Handle;
    .param p1, "supportedAbis"    # [Ljava/lang/String;
    .param p2, "fromCopy"    # Z
    ...
    .line 230
    .local v0, "apkHandle":J
    invoke-static {v0, v1, p2, p1}, Lcom/android/internal/content/NativeLibraryHelper;->nativeFindSupportedAbi(JZ[Ljava/lang/String;)I
...
.method private static native nativeFindSupportedAbi(JZ[Ljava/lang/String;)I
.end method

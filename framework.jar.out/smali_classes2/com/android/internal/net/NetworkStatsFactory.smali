...
.field private final mStatsXtUidWithPids:Ljava/io/File;
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    const-string v1, "net/xt_qtaguid/stats_pid"

    invoke-direct {v0, p1, v1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/internal/net/NetworkStatsFactory;->mStatsXtUidWithPids:Ljava/io/File;
...
.method public static javaReadNetworkStatsDetailWithPids(Ljava/io/File;I)Landroid/net/NetworkStats;
    .locals 1
    .param p0, "detailPath"    # Ljava/io/File;
    .param p1, "limitUid"    # I
    .annotation system Ldalvik/annotation/Throws;
...
.method public static native nativeReadNetworkStatsDetailWithPids(Landroid/net/NetworkStats;Ljava/lang/String;I)I
.end method
...
.method public readNetworkStatsDetailWithPids()Landroid/net/NetworkStats;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/net/NetworkStatsFactory;->readNetworkStatsDetailWithPids(I)Landroid/net/NetworkStats;
...
.method public readNetworkStatsDetailWithPids(I)Landroid/net/NetworkStats;
    .locals 4
    .param p1, "limitUid"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 295
    iget-object v1, p0, Lcom/android/internal/net/NetworkStatsFactory;->mStatsXtUidWithPids:Ljava/io/File;

    invoke-virtual {v1}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1, p1}, Lcom/android/internal/net/NetworkStatsFactory;->nativeReadNetworkStatsDetailWithPids(Landroid/net/NetworkStats;Ljava/lang/String;I)I
    ...
    const-string v2, "readNetworkStatsDetailWithPids:Failed to parse network stats with pid"

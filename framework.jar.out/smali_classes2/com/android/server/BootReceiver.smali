...
.method private static addFileWithFootersToDropBox(Landroid/os/DropBoxManager;Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v10, "panic"

    invoke-static {v8, v9, v10}, Landroid/os/OppoManager;->writeLogToPartition(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v11, "write kernel panic log size:"
    ...
    invoke-virtual {p0, v0, v8}, Landroid/os/DropBoxManager;->addText(Ljava/lang/String;Ljava/lang/String;)V
...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    invoke-static {v7, v8, v10}, Landroid/os/FileUtils;->readTextFile(Ljava/io/File;ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 149
    .local v17, "bootReason":Ljava/lang/String;
    ...
    .line 170
    :cond_2
    sget v6, Landroid/os/OppoManager;->TYPE_PANIC:I

    invoke-static {v6}, Landroid/os/OppoManager;->incrementCriticalData(I)I
    ...
    const-string v7, "increment panic times failed!!"
    ...
    invoke-static {v6}, Landroid/os/OppoManager;->readCriticalData(I)I

    move-result v20

    .line 175
    .local v20, "panicTime":I
    ...
    sget v14, Lcom/android/server/BootReceiver;->LOG_SIZE:I
    ...
    invoke-static/range {v10 .. v15}, Lcom/android/server/BootReceiver;->addFileToDropBox(Landroid/os/DropBoxManager;Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    .line 186
    .local v19, "now":Ljava/lang/String;
    const-string v6, "ro.runtime.firstboot"
    ...
    .line 217
    .end local v19    # "now":Ljava/lang/String;
    :cond_a
    const-string v6, "BootReceiver"

    const-string v7, "system_server crashed!"

    invoke-static {v6, v7}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 218
    const-string v6, "persist.sys.panic.file"
    ...
    .line 219
    .local v9, "systemcrashFile":Ljava/lang/String;
    ...
    .line 220
    .local v23, "sysFile":Ljava/io/File;
    if-eqz v23, :cond_f
    ...
    .line 221
    const-string v6, "persist.sys.send.file"
    ...
    const-string v11, "SYSTEM_SERVER_WATCHDOG"
    ...
    invoke-static {v0, v6, v7}, Landroid/os/FileUtils;->readTextFile(Ljava/io/File;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v6, v7}, Landroid/os/OppoManager;->writeLogToPartition(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v8, "write andrroid crash log size:"
    ...
    .line 240
    sget v6, Landroid/os/OppoManager;->TYPE_SYSTEM_CRASH:I
    ...
    .line 228
    const-string v6, "SYSTEM_SERVER_GZ"

    const-string v7, "LOG FOR GZ"
    ...
    const-string v8, "system_Server crash but can not get efficacious log!"
    ...
    .line 263
    .end local v9    # "systemcrashFile":Ljava/lang/String;
    .end local v23    # "sysFile":Ljava/io/File;
    .restart local v18    # "i":I
    .restart local v25    # "tombstoneFiles":[Ljava/io/File;
    :cond_10
    new-instance v10, Lcom/android/server/BootReceiver$2;
    ...
    invoke-direct/range {v10 .. v16}, Lcom/android/server/BootReceiver$2;-><init>(Lcom/android/server/BootReceiver;Ljava/lang/String;ILandroid/os/DropBoxManager;Landroid/content/SharedPreferences;Ljava/lang/String;)V

    sput-object v10, Lcom/android/server/BootReceiver;->sTombstoneObserver:Landroid/os/FileObserver;

.class public Lcom/oppo/media/OppoMediaMetadataRetriever;
.super Ljava/lang/Object;
.source "OppoMediaMetadataRetriever.java"
...
.method static constructor <clinit>()V
    ...
    .line 46
    const-string v0, "oppometadataretriever_jni"

    invoke-static {v0}, Ljava/lang/System;->loadLibrary(Ljava/lang/String;)V

    .line 47
    invoke-static {}, Lcom/oppo/media/OppoMediaMetadataRetriever;->native_init()V
...
.method public constructor <init>()V
    ...
    .line 57
    invoke-direct {p0}, Lcom/oppo/media/OppoMediaMetadataRetriever;->native_setup()V
...
.method protected finalize()V
    ...
    .line 308
    :try_start_0
    invoke-direct {p0}, Lcom/oppo/media/OppoMediaMetadataRetriever;->native_finalize()V
    :try_end_0
...
.method public getEmbeddedPicture()[B
    ...
    invoke-direct {p0, v0}, Lcom/oppo/media/OppoMediaMetadataRetriever;->getEmbeddedPicture(I)[B
...
.method public getFrameAtTime()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/oppo/media/OppoMediaMetadataRetriever;->getFrameAtTime(JI)Landroid/graphics/Bitmap;
...
.method public getFrameAtTime(J)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/oppo/media/OppoMediaMetadataRetriever;->getFrameAtTime(JI)Landroid/graphics/Bitmap;
...
.method public getFrameAtTime(JI)Landroid/graphics/Bitmap;
    ...
    .line 234
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lcom/oppo/media/OppoMediaMetadataRetriever;->_getFrameAtTime(JI)Landroid/graphics/Bitmap;
...
.method public setDataSource(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, v0}, Lcom/oppo/media/OppoMediaMetadataRetriever;->setDataSource(Ljava/lang/String;)V
    ...
    .line 177
    invoke-virtual {p0, v1}, Lcom/oppo/media/OppoMediaMetadataRetriever;->setDataSource(Ljava/io/FileDescriptor;)V
    :try_end_6
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/oppo/media/OppoMediaMetadataRetriever;->setDataSource(Ljava/io/FileDescriptor;JJ)V
    :try_end_8
...
.method public setDataSource(Ljava/lang/String;Ljava/util/Map;)V
    ...
    :cond_0
    invoke-direct {p0, p1, v3, v4}, Lcom/oppo/media/OppoMediaMetadataRetriever;->_setDataSource(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V

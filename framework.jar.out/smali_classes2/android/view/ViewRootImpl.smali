...
.field private mDeltLastTraversal:J
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;)V
    ...
    const-string v1, "sys.perflock.enable"
    ...
    iput-boolean v0, p0, Landroid/view/ViewRootImpl;->mPerfLockEnabled:Z
    ...
    const-string v2, "mPerfLockEnabled "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Landroid/view/ViewRootImpl;->mPerfLockEnabled:Z
...
.method private draw(Z)V
    ...
    iget-boolean v4, v0, Landroid/view/ViewRootImpl;->mPerfLockEnabled:Z
    ...
    iget-wide v8, v0, Landroid/view/ViewRootImpl;->mDeltLastTraversal:J

    .end local v8    # "yOffset":I
    move-object/from16 v7, p0

    invoke-virtual/range {v4 .. v9}, Landroid/view/HardwareRenderer;->draw(Landroid/view/View;Landroid/view/View$AttachInfo;Landroid/view/HardwareRenderer$HardwareDrawCallbacks;J)V
    ...
    .restart local v24    # "invalidateRoot":Z
...
.method doTraversal()V
    ...
    .line 1062
    iget-boolean v4, p0, Landroid/view/ViewRootImpl;->mTraversalScheduled:Z

    if-eqz v4, :cond_1

    .line 1063
    iput-boolean v8, p0, Landroid/view/ViewRootImpl;->mTraversalScheduled:Z

    .line 1064
    iget-object v4, p0, Landroid/view/ViewRootImpl;->mHandler:Landroid/view/ViewRootImpl$ViewRootHandler;

    invoke-virtual {v4}, Landroid/view/ViewRootImpl$ViewRootHandler;->getLooper()Landroid/os/Looper;

    move-result-object v4

    iget v5, p0, Landroid/view/ViewRootImpl;->mTraversalBarrier:I

    invoke-virtual {v4, v5}, Landroid/os/Looper;->removeSyncBarrier(I)V

    .line 1066
    iget-boolean v4, p0, Landroid/view/ViewRootImpl;->mProfile:Z

    if-eqz v4, :cond_0

    .line 1067
    const-string v4, "ViewAncestor"

    invoke-static {v4}, Landroid/os/Debug;->startMethodTracing(Ljava/lang/String;)V

    .line 1070
    :cond_0
    const-string v4, "performTraversals"
    ...
    iput-wide v4, p0, Landroid/view/ViewRootImpl;->mDeltLastTraversal:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1085
    iput-boolean v8, p0, Landroid/view/ViewRootImpl;->mProfile:Z

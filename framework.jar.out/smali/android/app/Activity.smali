...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v2, v5}, Landroid/app/AppOpsManager;->removeOps(Ljava/lang/String;)V
    ...
    iput-object v5, p0, Landroid/app/Activity;->mAllLoaderManagers:Landroid/util/ArrayMap;

    .line 949
    :cond_0
    iget-object v5, p0, Landroid/app/Activity;->mActivityInfo:Landroid/content/pm/ActivityInfo;
    ...
    .line 957
    const-string v5, "android:fragments"
    ...
    iget-object v5, v5, Landroid/app/Activity$NonConfigurationInstances;->fragments:Ljava/util/ArrayList;

    :goto_1
    invoke-virtual {v6, v3, v5}, Landroid/app/FragmentManagerImpl;->restoreAllState(Landroid/os/Parcelable;Ljava/util/ArrayList;)V

    .line 961
    .end local v3    # "p":Landroid/os/Parcelable;
    :cond_2
    iget-object v5, p0, Landroid/app/Activity;->mFragments:Landroid/app/FragmentManagerImpl;

    invoke-virtual {v5}, Landroid/app/FragmentManagerImpl;->dispatchCreate()V
    ...
    invoke-virtual {v5, p0, p1}, Landroid/app/Application;->dispatchActivityCreated(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v5, p0}, Landroid/app/VoiceInteractor;->attachActivity(Landroid/app/Activity;)V
    ...
    const v6, #android:array@boost_activityList#t

    invoke-virtual {v5, v6}, Landroid/content/res/Resources;->getStringArray(I)[Ljava/lang/String;

    move-result-object v5

    iput-object v5, p0, Landroid/app/Activity;->mPerfActivityList:[Ljava/lang/String;
    ...
    const v6, #android:integer@ascrollboost_cpuboost#t

    invoke-virtual {v5, v6}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v5

    sput v5, Landroid/app/Activity;->mAsCpuBoost:I
    ...
    const v6, #android:integer@ascrollboost_schedboost#t

    invoke-virtual {v5, v6}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v5

    sput v5, Landroid/app/Activity;->mAsSchedBoost:I
    ...
    const v6, #android:integer@ascrollboost_pcdisbl#t

    invoke-virtual {v5, v6}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v5

    sput v5, Landroid/app/Activity;->mAsPcDisblBoost:I

    .line 981
    iget-object v5, p0, Landroid/app/Activity;->mActivityInfo:Landroid/content/pm/ActivityInfo;

    invoke-virtual {v5}, Landroid/content/pm/ActivityInfo;->getDarkThemeResource()I
    ...
    .line 982
    .local v1, "hasDarkTheme":Z
    :goto_2
    invoke-virtual {p0, v1}, Landroid/app/Activity;->setHasDarkTheme(Z)V

    .line 983
    if-eqz v1, :cond_5

    .line 984
    invoke-virtual {p0}, Landroid/app/Activity;->isDarkTheme()Z
    ...
    invoke-virtual {v5, v1}, Landroid/app/ActionBar;->setDefaultDisplayHomeAsUpEnabled(Z)V
    ...
    .restart local v1    # "hasDarkTheme":Z
    :cond_9
    iget-object v5, p0, Landroid/app/Activity;->mActivityInfo:Landroid/content/pm/ActivityInfo;
...
.method protected onDestroy()V
    ...
    invoke-virtual {v2, v6}, Landroid/app/AppOpsManager;->checkOps(Ljava/lang/String;)V

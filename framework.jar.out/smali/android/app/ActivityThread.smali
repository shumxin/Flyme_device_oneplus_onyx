...
.field public static final FORCE_CHOOSING_VEBVIEW:I = 0xb
...
.method static synthetic access$602(Z)Z
    ...
    .prologue
    .line 155
    sput-boolean p0, Landroid/app/ActivityThread;->DEBUG_SERVICE:Z

    return p0
.end method

.method static synthetic access$700(Landroid/app/ActivityThread;ILjava/lang/Object;IIZ)V
    .locals 0
    .param p0, "x0"    # Landroid/app/ActivityThread;
    .param p1, "x1"    # I
    .param p2, "x2"    # Ljava/lang/Object;
...
.method private attach(Z)V
    ...
    .line 5191
    const-string/jumbo v4, "sys.activity.thread.log"
    ...
    .line 5193
    sput-boolean v6, Landroid/app/ActivityThread;->localLOGV:Z

    .line 5194
    sput-boolean v6, Landroid/app/ActivityThread;->DEBUG_BROADCAST:Z

    .line 5195
    sput-boolean v6, Landroid/app/ActivityThread;->DEBUG_SERVICE:Z

    .line 5196
    sput-boolean v6, Landroid/app/ActivityThread;->DEBUG_MESSAGES:Z
    ...
    invoke-interface {v2, v4}, Landroid/app/IActivityManager;->attachApplication(Landroid/app/IApplicationThread;)V
    :try_end_0
    ...
    invoke-direct {v4, p0, v2}, Landroid/app/ActivityThread$2;-><init>(Landroid/app/ActivityThread;Landroid/app/IActivityManager;)V
    ...
    .line 5197
    .restart local v3    # "open":Ljava/lang/String;
    :cond_1
    if-eqz v3, :cond_0
    ...
    .line 5198
    sput-boolean v7, Landroid/app/ActivityThread;->localLOGV:Z

    .line 5199
    sput-boolean v7, Landroid/app/ActivityThread;->DEBUG_BROADCAST:Z

    .line 5200
    sput-boolean v7, Landroid/app/ActivityThread;->DEBUG_SERVICE:Z

    .line 5201
    sput-boolean v7, Landroid/app/ActivityThread;->DEBUG_MESSAGES:Z
...
.method private createBaseContextForActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/Activity;)Landroid/content/Context;
    ...
    invoke-virtual {v5, v4, v10}, Landroid/hardware/display/DisplayManagerGlobal;->getRealDisplay(ILandroid/os/IBinder;)Landroid/view/Display;
    ...
    invoke-virtual {v10}, Landroid/content/pm/ActivityInfo;->getThemeResource()I
...
.method private getPackageInfo(Landroid/content/pm/ApplicationInfo;Landroid/content/res/CompatibilityInfo;Ljava/lang/ClassLoader;ZZZ)Landroid/app/LoadedApk;
    ...
    const-string v1, "Loading code package "
    ...
    .restart local v0    # "packageInfo":Landroid/app/LoadedApk;
    :cond_6
    const-string v1, "Loading resource-only package "
...
.method private handleBindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    sget-boolean v3, Landroid/app/ActivityThread;->DEBUG_SERVICE:Z
    ...
    const-string v5, "handleBindService s="
...
.method private handleServiceArgs(Landroid/app/ActivityThread$ServiceArgsData;)V
    ...
    const-string v5, "handleServiceArgs serviceDoneExecuting s  "
...
.method private handleStopService(Landroid/os/IBinder;)V
    ...
    const-string v6, "Destroying service "
...
.method private performDestroyActivity(Landroid/os/IBinder;ZIZ)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    const-string v5, "Performing finish of "
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    const-string v6, "Performing launch of "
...
.method private performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    const-string v3, "Performing stop of "
...
.method public final startActivityNow(Landroid/app/Activity;Ljava/lang/String;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Landroid/os/Bundle;Landroid/app/Activity$NonConfigurationInstances;)Landroid/app/Activity;
    ...
    invoke-direct {p0, v2, v3}, Landroid/app/ActivityThread;->performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    const-string v4, ").getComponent() returned null"

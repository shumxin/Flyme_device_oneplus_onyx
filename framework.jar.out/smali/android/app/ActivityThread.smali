...
.field private static final END_SESSION:I = 0x0
...
.field private static final START_SESSION:I = 0x1
...
.method static synthetic access$3300(Landroid/app/ActivityThread;Landroid/content/Context;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Landroid/app/ActivityThread;
    ...
    .prologue
    .line 155
    invoke-direct {p0, p1, p2}, Landroid/app/ActivityThread;->handleInsightActivity(Landroid/content/Context;Ljava/lang/String;)V
...
.method private handleInsightActivity(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
    ...
    .line 5360
    .local v0, "tracker":Lnet/oneplus/odm/insight/tracker/AppTracker;
    const/4 v1, 0x0

    invoke-virtual {v0, p2, v1}, Lnet/oneplus/odm/insight/tracker/AppTracker;->onEvent(Ljava/lang/String;Ljava/util/Map;)V
...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    invoke-virtual {v6, v10, v11}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    iget-object v4, v0, Landroid/app/ActivityThread;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;
    ...
    check-cast v4, Landroid/service/theme/MaterialThemeManager;

    move-object/from16 v0, p0

    iput-object v4, v0, Landroid/app/ActivityThread;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;
    ...
    invoke-virtual {v4}, Landroid/service/theme/MaterialThemeManager;->getMaterialTheme()I
    ...
    invoke-virtual {v4}, Landroid/content/pm/ActivityInfo;->getDarkThemeResource()I
...
.method private sendAnalyticsData(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "event"    # Ljava/lang/String;
    ...
    :goto_0
    invoke-direct {p0, v1, p1, v0}, Landroid/app/ActivityThread;->sendMessage(ILjava/lang/Object;I)V
...
.method getTopLevelResources(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    .locals 10
    .param p1, "packageName"    # Ljava/lang/String;
    ...
    .param p8, "compInfo"    # Landroid/content/res/CompatibilityInfo;
...
.method final performPauseActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZ)Landroid/os/Bundle;
    ...
    invoke-direct {p0, v4, v6}, Landroid/app/ActivityThread;->sendAnalyticsData(Landroid/content/Context;Ljava/lang/String;)V
...
.method public final performResumeActivity(Landroid/os/IBinder;Z)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    invoke-direct {p0, v2, v3}, Landroid/app/ActivityThread;->sendAnalyticsData(Landroid/content/Context;Ljava/lang/String;)V

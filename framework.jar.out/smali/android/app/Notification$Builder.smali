...
.method private resolveColor()I
    ...
    .prologue
    .line 3320
    iget v1, p0, Landroid/app/Notification$Builder;->mColor:I

    if-nez v1, :cond_2

    .line 3322
    :try_start_0
    iget-object v1, p0, Landroid/app/Notification$Builder;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;
    ...
    const-string/jumbo v2, "material_theme"
    ...
    iput-object v1, p0, Landroid/app/Notification$Builder;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;

    .line 3326
    :cond_0
    iget-object v1, p0, Landroid/app/Notification$Builder;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;

    invoke-virtual {v1}, Landroid/service/theme/MaterialThemeManager;->getColorInt()I
    :try_end_0
    ...
    const v2, #android:color@notification_icon_bg_color#t
...
.method public buildUnstyled()Landroid/app/Notification;
    ...
    iput v2, v1, Landroid/app/Notification;->iconLevel:I
    ...
    iget-boolean v2, p0, Landroid/app/Notification$Builder;->mIsDefaultColor:Z

    if-nez v2, :cond_0

    iget v2, p0, Landroid/app/Notification$Builder;->mColor:I
    ...
    :goto_0
    iput-boolean v2, v1, Landroid/app/Notification;->isDefaultColor:Z

    iget-boolean v2, v1, Landroid/app/Notification;->isDefaultColor:Z

    if-eqz v2, :cond_2

    :try_start_0
    iget-object v2, p0, Landroid/app/Notification$Builder;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;

    if-nez v2, :cond_1

    iget-object v2, p0, Landroid/app/Notification$Builder;->mContext:Landroid/content/Context;

    const-string v4, "material_theme"

    invoke-virtual {v2, v4}, Landroid/content/Context;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/service/theme/MaterialThemeManager;

    iput-object v2, p0, Landroid/app/Notification$Builder;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;

    :cond_1
    iget-object v2, p0, Landroid/app/Notification$Builder;->mMaterialThemeManager:Landroid/service/theme/MaterialThemeManager;

    invoke-virtual {v2}, Landroid/service/theme/MaterialThemeManager;->getColorInt()I
    ...
    iput-object v2, v1, Landroid/app/Notification;->fullScreenIntent:Landroid/app/PendingIntent;
    ...
    iput-object v2, v1, Landroid/app/Notification;->largeIcon:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Landroid/app/Notification$Builder;->mAudioAttributes:Landroid/media/AudioAttributes;
    ...
    :cond_5
    iget-object v2, p0, Landroid/app/Notification$Builder;->mCategory:Ljava/lang/String;

    iput-object v2, v1, Landroid/app/Notification;->category:Ljava/lang/String;

    iget-object v2, p0, Landroid/app/Notification$Builder;->mGroupKey:Ljava/lang/String;

    # setter for: Landroid/app/Notification;->mGroupKey:Ljava/lang/String;
    invoke-static {v1, v2}, Landroid/app/Notification;->access$402(Landroid/app/Notification;Ljava/lang/String;)Ljava/lang/String;

    iget-object v2, p0, Landroid/app/Notification$Builder;->mSortKey:Ljava/lang/String;

    # setter for: Landroid/app/Notification;->mSortKey:Ljava/lang/String;
    invoke-static {v1, v2}, Landroid/app/Notification;->access$502(Landroid/app/Notification;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v2, v1, Landroid/app/Notification;->actions:[Landroid/app/Notification$Action;
    ...
    :cond_6
    iget v2, p0, Landroid/app/Notification$Builder;->mVisibility:I

    iput v2, v1, Landroid/app/Notification;->visibility:I

    iget-object v2, p0, Landroid/app/Notification$Builder;->mPublicVersion:Landroid/app/Notification;
    ...
    iput-object v2, v1, Landroid/app/Notification;->publicVersion:Landroid/app/Notification;
    ...
    iget v2, p0, Landroid/app/Notification$Builder;->mStatusBarIcon:I

    # setter for: Landroid/app/Notification;->mStatusBarIcon:I
    invoke-static {v1, v2}, Landroid/app/Notification;->access$602(Landroid/app/Notification;I)I

    iget-boolean v2, p0, Landroid/app/Notification$Builder;->mShowOnStatusBar:Z

    # setter for: Landroid/app/Notification;->mShowOnStatusBar:Z
    invoke-static {v1, v2}, Landroid/app/Notification;->access$702(Landroid/app/Notification;Z)Z

    iget-boolean v2, p0, Landroid/app/Notification$Builder;->mShowChronometerOnStatusBar:Z

    # setter for: Landroid/app/Notification;->mShowChronometerOnStatusBar:Z
    invoke-static {v1, v2}, Landroid/app/Notification;->access$802(Landroid/app/Notification;Z)Z
    ...
    invoke-static {v1, v2, v3}, Landroid/app/Notification;->access$902(Landroid/app/Notification;J)J

    iget v2, p0, Landroid/app/Notification$Builder;->mChronometerState:I

    # setter for: Landroid/app/Notification;->mChronometerState:I
    invoke-static {v1, v2}, Landroid/app/Notification;->access$1002(Landroid/app/Notification;I)I

    iget v2, p0, Landroid/app/Notification$Builder;->mTextOnStatusBar:I

    # setter for: Landroid/app/Notification;->mTextOnStatusBar:I
    invoke-static {v1, v2}, Landroid/app/Notification;->access$1102(Landroid/app/Notification;I)I

    iget v2, p0, Landroid/app/Notification$Builder;->mBackgroundColorOnStatusBar:I

    # setter for: Landroid/app/Notification;->mBackgroundColorOnStatusBar:I
    invoke-static {v1, v2}, Landroid/app/Notification;->access$1202(Landroid/app/Notification;I)I

    iget v2, p0, Landroid/app/Notification$Builder;->mPriorityOnStatusBar:I

    # setter for: Landroid/app/Notification;->mPriorityOnStatusBar:I
    invoke-static {v1, v2}, Landroid/app/Notification;->access$1302(Landroid/app/Notification;I)I

    iget-object v2, p0, Landroid/app/Notification$Builder;->mActionIntentOnStatusBar:Landroid/content/Intent;

    # setter for: Landroid/app/Notification;->mActionIntentOnStatusBar:Landroid/content/Intent;
    invoke-static {v1, v2}, Landroid/app/Notification;->access$1402(Landroid/app/Notification;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public setColor(I)Landroid/app/Notification$Builder;
    ...
    :goto_0
    iput-boolean v1, p0, Landroid/app/Notification$Builder;->mIsDefaultColor:Z

    iget-boolean v1, p0, Landroid/app/Notification$Builder;->mIsDefaultColor:Z
    ...
    const-string v2, "material_theme"

...
.method private calculateMaxLines()I
    ...
    invoke-static {v5}, Landroid/app/Notification$Builder;->access$2800(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroid/app/Notification$Builder;->access$2000(Landroid/app/Notification$Builder;)Z
    ...
    invoke-static {v5}, Landroid/app/Notification$Builder;->access$1700(Landroid/app/Notification$Builder;)Ljava/lang/CharSequence;
...
.method private makeBigContentView()Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Landroid/app/Notification$Builder;->access$2300(Landroid/app/Notification$Builder;)Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v3}, Landroid/app/Notification$Builder;->access$2302(Landroid/app/Notification$Builder;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    .line 4246
    iget-object v2, p0, Landroid/app/Notification$BigTextStyle;->mBuilder:Landroid/app/Notification$Builder;

    # invokes: Landroid/app/Notification$Builder;->getBigTextLayoutResource()I
    invoke-static {v2}, Landroid/app/Notification$Builder;->access$2600(Landroid/app/Notification$Builder;)I
    ...
    # setter for: Landroid/app/Notification$Builder;->mContentText:Ljava/lang/CharSequence;
    invoke-static {v2, v1}, Landroid/app/Notification$Builder;->access$2302(Landroid/app/Notification$Builder;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v3}, Landroid/app/Notification$Builder;->access$1800(Landroid/app/Notification$Builder;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v0}, Landroid/app/Notification$Builder;->access$2700(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;)V
    ...
    invoke-static {v2, v0, v3}, Landroid/app/Notification$Builder;->access$2400(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;I)Z

...
.method private makeMediaBigContentView()Landroid/widget/RemoteViews;
    ...
    invoke-static {v4}, Landroid/app/Notification$Builder;->access$2800(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    ...
    invoke-static {v4, v5, v6}, Landroid/app/Notification$Builder;->access$3100(Landroid/app/Notification$Builder;IZ)Landroid/widget/RemoteViews;
...
.method private makeMediaContentView()Landroid/widget/RemoteViews;
    ...
    # invokes: Landroid/app/Notification$Builder;->applyStandardTemplate(IZ)Landroid/widget/RemoteViews;
    invoke-static {v7, v8, v6}, Landroid/app/Notification$Builder;->access$3100(Landroid/app/Notification$Builder;IZ)Landroid/widget/RemoteViews;
    ...
    # getter for: Landroid/app/Notification$Builder;->mActions:Ljava/util/ArrayList;
    invoke-static {v7}, Landroid/app/Notification$Builder;->access$2800(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
...
.method private styleText(Landroid/widget/RemoteViews;)V
    ...
    # getter for: Landroid/app/Notification$Builder;->mContext:Landroid/content/Context;
    invoke-static {v2}, Landroid/app/Notification$Builder;->access$1900(Landroid/app/Notification$Builder;)Landroid/content/Context;
    ...
    invoke-static {v2}, Landroid/app/Notification$Builder;->access$3200(Landroid/app/Notification$Builder;)Z
    ...
    invoke-static {v2}, Landroid/app/Notification$Builder;->access$3300(Landroid/app/Notification$Builder;)Z
...
.method public populateContentView(Landroid/app/Notification;)V
    ...
    invoke-static {v0, p1, v1}, Landroid/app/Notification$Builder;->access$3000(Landroid/app/Notification$Builder;Landroid/app/Notification;Landroid/widget/RemoteViews;)V

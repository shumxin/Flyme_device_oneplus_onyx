...
.method protected constructor <init>(Landroid/content/Context;Z)V
    ...
    invoke-static {p1, v0}, Landroid/app/AlertDialog;->resolveColoredDialogTheme(Landroid/content/Context;I)I
...
.method protected constructor <init>(Landroid/content/Context;ZI)V
    ...
    invoke-static {p1, p3}, Landroid/app/AlertDialog;->resolveColoredDialogTheme(Landroid/content/Context;I)I
    ...
    .line 126
    :cond_0
    invoke-static {p1, p3}, Landroid/app/AlertDialog;->resolveDialogTheme(Landroid/content/Context;I)I
...
.method static resolveColoredDialogTheme(Landroid/content/Context;I)I
    .locals 3
    ...
    .line 180
    invoke-virtual {p0, v2}, Landroid/content/Context;->isDarkTheme(Z)Z
    ...
    .line 181
    invoke-virtual {p0, v2}, Landroid/content/Context;->getColorId(Z)Landroid/service/theme/MaterialThemeManager$COLOR;

    move-result-object v0

    .line 182
    .local v0, "color":Landroid/service/theme/MaterialThemeManager$COLOR;
    sget-object v1, Landroid/app/AlertDialog$1;->$SwitchMap$android$service$theme$MaterialThemeManager$COLOR:[I

    invoke-virtual {v0}, Landroid/service/theme/MaterialThemeManager$COLOR;->ordinal()I
    ...
    .line 202
    .end local v0    # "color":Landroid/service/theme/MaterialThemeManager$COLOR;
    :cond_0
    invoke-static {p0, p1}, Landroid/app/AlertDialog;->resolveDialogTheme(Landroid/content/Context;I)I
    ...
    .line 184
    .restart local v0    # "color":Landroid/service/theme/MaterialThemeManager$COLOR;
    :pswitch_0
    const v1, 0x40302dc

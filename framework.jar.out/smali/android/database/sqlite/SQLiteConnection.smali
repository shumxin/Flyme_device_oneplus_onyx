...
.field private static ANDROID_DEFAULT_JOURNAL_MODE:Ljava/lang/String; = null

.field private static final CTS_DATABASES:Ljava/util/regex/Pattern;
...
.field private static final YOULOFT:Ljava/util/regex/Pattern;
...
.method static constructor <clinit>()V
    ...
    .line 109
    const-string v0, ".*com.android.cts.content.*databasetest\\d+.*"

    invoke-static {v0}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;

    move-result-object v0

    sput-object v0, Landroid/database/sqlite/SQLiteConnection;->CTS_DATABASES:Ljava/util/regex/Pattern;

    .line 111
    const-string v0, ".*com.youloft.*"

    invoke-static {v0}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;

    move-result-object v0

    sput-object v0, Landroid/database/sqlite/SQLiteConnection;->YOULOFT:Ljava/util/regex/Pattern;

    .line 112
    const-string v0, "PERSIST"

    sput-object v0, Landroid/database/sqlite/SQLiteConnection;->ANDROID_DEFAULT_JOURNAL_MODE:Ljava/lang/String;
...
.method private hoistAndroidDefaultJournalMode()V
    .locals 2
    ...
    .line 338
    :cond_1
    sget-object v0, Landroid/database/sqlite/SQLiteConnection;->ANDROID_DEFAULT_JOURNAL_MODE:Ljava/lang/String;
...
.method private open()V
    ...
    sget-boolean v7, Landroid/database/sqlite/SQLiteDebug;->DEBUG_SQL_STATEMENTS:Z

    sget-boolean v8, Landroid/database/sqlite/SQLiteDebug;->DEBUG_SQL_TIME:Z

    invoke-static {v4, v5, v6, v7, v8}, Landroid/database/sqlite/SQLiteConnection;->nativeOpen(Ljava/lang/String;ILjava/lang/String;ZZ)J
    ...
    sget-object v4, Landroid/database/sqlite/SQLiteConnection;->YOULOFT:Ljava/util/regex/Pattern;
    ...
    sget-object v4, Landroid/database/sqlite/SQLiteConnection;->CTS_DATABASES:Ljava/util/regex/Pattern;
    ...
    .line 241
    :cond_1
    invoke-direct {p0}, Landroid/database/sqlite/SQLiteConnection;->hoistAndroidDefaultJournalMode()V

...
.method private acquirePreparedStatement(Ljava/lang/String;)Landroid/database/sqlite/SQLiteConnection$PreparedStatement;
    ...
    .line 893
    const-string v0, "SELECT a._id as _id, a.code as code, a.name as name, a.pinyin as pinyin, b.last_time as last_time FROM hx_stocklist a, hx_searchlog b WHERE a.code = b.code group by last_time, code order by last_time DESC LIMIT 10"
    ...
    .line 894
    const-string p1, "SELECT a._id as _id, a.code as code, a.name as name, a.pinyin as pinyin, b.last_time as last_time FROM hx_stocklist a, hx_searchlog b WHERE a.code = b.code group by last_time, a.code order by last_time DESC LIMIT 10"

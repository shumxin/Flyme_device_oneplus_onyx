...
.method public static getCardPresent(I)Z
    .locals 4
    .param p0, "slotIdx"    # I
    ...
    const-string v3, "getCardPresent:- empty subId return false"
    ...
    invoke-static {v1}, Landroid/telephony/SubscriptionManager;->isCardPresent(I)Z
...
.method public getCellLocation()Landroid/telephony/CellLocation;
    ...
    .line 750
    const-string v3, "TelephonyManager|getCellLocation|--end"

    .line 751
    .local v3, "paras":Ljava/lang/String;
    invoke-static {v3}, Landroid/util/SeempLog;->record(Ljava/lang/String;)I

    .line 755
    .end local v3    # "paras":Ljava/lang/String;
    :cond_0
    :try_start_0
    invoke-direct {p0}, Landroid/telephony/TelephonyManager;->getITelephony()Lcom/android/internal/telephony/ITelephony;
    ...
    invoke-interface {v5}, Lcom/android/internal/telephony/ITelephony;->getCellLocation()Landroid/os/Bundle;
...
.method public getDeviceId()Ljava/lang/String;
    ...
    .line 631
    const-string v1, "TelephonyManager|getDeviceId|--end"
    ...
    invoke-interface {v3}, Lcom/android/internal/telephony/ITelephony;->getDeviceId()Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_1
...
.method public getDeviceId(I)Ljava/lang/String;
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telephony/IPhoneSubInfo;->getDeviceIdForPhone(I)Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_1
...
.method public getLine1Number()Ljava/lang/String;
    ...
    .line 1994
    const-string v0, "TelephonyManager|getLine1Number|--end"
    ...
    invoke-virtual {p0, v1}, Landroid/telephony/TelephonyManager;->getLine1NumberForSubscriber(I)Ljava/lang/String;
...
.method public getNeighboringCellInfo()Ljava/util/List;
    ...
    .line 836
    const-string v1, "TelephonyManager|getNeighboringCellInfo|--end"
...
.method public getSimSerialNumber()Ljava/lang/String;
    ...
    .line 1836
    const-string v0, "TelephonyManager|getSimSerialNumber|--end"
    ...
    invoke-virtual {p0, v1}, Landroid/telephony/TelephonyManager;->getSimSerialNumber(I)Ljava/lang/String;
...
.method public getSimSerialNumber(I)Ljava/lang/String;
    ...
    .line 1855
    const-string v1, "TelephonyManager|getSimSerialNumber|--end"
    ...
    invoke-interface {v3, p1}, Lcom/android/internal/telephony/IPhoneSubInfo;->getIccSerialNumberForSubscriber(I)Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_1
...
.method public setDataEnabledUsingSubId(IZ)V
    ...
    sget v2, Landroid/app/AppOpsManager;->OP_DATA_CONNECT_CHANGE:I

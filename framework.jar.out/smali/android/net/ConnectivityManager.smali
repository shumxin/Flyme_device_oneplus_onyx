...
.field private static sMmsRequestSequenceNum:I
...
.method static constructor <clinit>()V
    ...
    .line 1226
    sput v1, Landroid/net/ConnectivityManager;->sMmsRequestSequenceNum:I
...
.method private expireRequest(Landroid/net/NetworkCapabilities;I)V
    ...
    .line 1251
    sget v2, Landroid/net/ConnectivityManager;->sMmsRequestSequenceNum:I
    ...
    const-string/jumbo v4, "the last mms expireRequest need from the mms app, not the framework, here return"
    ...
    const-string v4, ", sMmsRequestSequenceNum="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget v4, Landroid/net/ConnectivityManager;->sMmsRequestSequenceNum:I
    ...
    const-string/jumbo v4, "release request when timer expires"
...
.method private renewRequestLocked(Landroid/net/ConnectivityManager$LegacyRequest;)V
    ...
    sput v0, Landroid/net/ConnectivityManager;->sMmsRequestSequenceNum:I
...
.method public startUsingNetworkFeatureForSubscription(ILjava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v10, "startUsingNetworkFeatureForSubscription: for "
    ...
    const-string/jumbo v8, "return APN_REQUEST_FAILED because current callState was active"
    ...
    .line 970
    :cond_1
    invoke-virtual {v4, p3}, Landroid/net/NetworkCapabilities;->setNetworkSpecifier(Ljava/lang/String;)V
    ...
    .line 974
    :try_start_0
    const-string v9, "ConnectivityManager"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "Looking for legacyRequest for netCap with hash: "
    ...
    const-string/jumbo v10, "sLegacyRequests has:"

    invoke-static {v9, v10}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 977
    sget-object v9, Landroid/net/ConnectivityManager;->sLegacyRequests:Ljava/util/HashMap;
    ...
    iget-object v10, v1, Landroid/net/ConnectivityManager$LegacyRequest;->networkRequest:Landroid/net/NetworkRequest;
    ...
    .line 985
    iget-object v6, v1, Landroid/net/ConnectivityManager$LegacyRequest;->currentNetwork:Landroid/net/Network;

...
.method static constructor <clinit>()V
    ...
    .line 250
    sput-boolean v5, Landroid/media/AudioService;->mIsH2:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 122
    iput-boolean v6, p0, Landroid/media/AudioService;->mDebugLog:Z
    ...
    .line 475
    iput v3, p0, Landroid/media/AudioService;->mRingerModeExternal:I

    .line 479
    iput v3, p0, Landroid/media/AudioService;->mThree_Key_Mode:I
    ...
    .line 581
    iput v3, p0, Landroid/media/AudioService;->mVolumeControlStream:I
    ...
    .line 653
    .local v8, "debug_log":Z
    if-eqz v8, :cond_0

    .line 654
    iput-boolean v4, p0, Landroid/media/AudioService;->mDebugLog:Z
    ...
    const-string/jumbo v1, "oppo.cmcc.client"
...
.method static synthetic access$10400(Landroid/media/AudioService;)Landroid/media/AudioManagerInternal$RingerModeDelegate;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10402(Landroid/media/AudioService;Landroid/media/AudioManagerInternal$RingerModeDelegate;)Landroid/media/AudioManagerInternal$RingerModeDelegate;
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10800(Landroid/media/AudioService;ZILjava/lang/String;Landroid/os/IBinder;I)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
...
.method static synthetic access$10908(Landroid/media/AudioService;)I
    .locals 2
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$8900(Landroid/media/AudioService;)Landroid/widget/Toast;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$9300(Landroid/media/AudioService;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method private adjustStreamVolume(IIILjava/lang/String;I)V
    ...
    iget-boolean v3, v0, Landroid/media/AudioService;->mDebugLog:Z
    ...
    const-string v5, "adjustStreamVolume ringerMode = "
    ...
    const-string v4, "do not vibrate if already in vibrate mode"
...
.method private checkForRingerModeChange(III)I
    ...
    const-string v3, "AudioManager.FLAG_SHOW_VIBRATE_HINT"
    ...
    .line 3622
    iget-boolean v2, p0, Landroid/media/AudioService;->mDebugLog:Z
    ...
    const-string v3, "can not change RingerMode in AudioManager.SLIENT_MODE"
...
.method private handleDeviceConnectionX(ZILjava/lang/String;)Z
    ...
    .line 5330
    iget v1, p0, Landroid/media/AudioService;->mSaveActiveStreamType:I
    ...
    invoke-static {v1, v3, p2}, Landroid/media/AudioSystem;->setStreamVolumeIndex(III)I
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    const-string/jumbo v2, "onSetWiredDeviceConnectionState not need broadcast name:"
...
.method private readPersistedSettings()V
    ...
    .line 1153
    :cond_1
    iget v8, p0, Landroid/media/AudioService;->mThree_Key_Mode:I
    ...
    .line 1154
    iget-boolean v8, p0, Landroid/media/AudioService;->mDebugLog:Z
    ...
    const-string/jumbo v10, "readPersistedSettings ringerMode = "
    ...
    const-string v10, ", change to vibrate in SLIENT_MODE"
...
.method private setRingerMode(ILjava/lang/String;Z)V
    ...
    .line 2279
    iget-boolean v4, p0, Landroid/media/AudioService;->mDebugLog:Z

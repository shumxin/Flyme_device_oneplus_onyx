...
.method private constructor <init>(Landroid/media/AudioService;)V
    ...
    iput v0, p0, Landroid/media/AudioService$AudioHandler;->mCurrentFadeVolume:I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget v2, v0, Landroid/media/AudioService$AudioHandler;->mCurrentFadeVolume:I

    add-int/lit8 v2, v2, 0x1

    move-object/from16 v0, p0

    iput v2, v0, Landroid/media/AudioService$AudioHandler;->mCurrentFadeVolume:I
    ...
    # getter for: Landroid/media/AudioService;->mSaveActiveStreamType:I
    invoke-static {v4}, Landroid/media/AudioService;->access$6200(Landroid/media/AudioService;)I
    ...
    # setter for: Landroid/media/AudioService;->mSaveActiveStreamVolume:I
    ...
    iget-boolean v2, v2, Landroid/media/AudioService;->mDebugLog:Z
    ...
    const-string/jumbo v4, "mSaveActiveStreamVolume="
    ...
    # getter for: Landroid/media/AudioService;->mSaveActiveStreamVolume:I
    invoke-static {v4}, Landroid/media/AudioService;->access$6100(Landroid/media/AudioService;)I
    ...
    const-string v4, " mCurrentFadeVolume="
    ...
    iget v4, v0, Landroid/media/AudioService$AudioHandler;->mCurrentFadeVolume:I
    ...
    # getter for: Landroid/media/AudioService;->mSaveActiveStreamVolume:I
    invoke-static {v3}, Landroid/media/AudioService;->access$6100(Landroid/media/AudioService;)I
    ...
    iget v3, v0, Landroid/media/AudioService$AudioHandler;->mCurrentFadeVolume:I

    invoke-static {v2, v3, v10}, Landroid/media/AudioSystem;->setStreamVolumeIndex(III)I
    ...
    invoke-virtual {v2, v3, v4, v5}, Landroid/media/AudioService$AudioHandler;->sendEmptyMessageDelayed(IJ)Z
    ...
    .end local v20    # "set":Ljava/util/Set;
    :catchall_0
    move-exception v2
    ...
    .restart local v20    # "set":Ljava/util/Set;
    :cond_5
    :try_start_1
    monitor-exit v3
    :try_end_1
    ...
    .line 4843
    .local v21, "streamState":Landroid/media/AudioService$VolumeStreamState;
    const/4 v2, 0x0

    # getter for: Landroid/media/AudioService$VolumeStreamState;->mIndexMax:I
    invoke-static/range {v21 .. v21}, Landroid/media/AudioService$VolumeStreamState;->access$6500(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    .line 4845
    invoke-virtual/range {v21 .. v21}, Landroid/media/AudioService$VolumeStreamState;->applyAllVolumes()V
    ...
    .end local v21    # "streamState":Landroid/media/AudioService$VolumeStreamState;
    .end local v22    # "streamType":I
    :cond_6
    const/4 v2, 0x0
    ...
    .line 4849
    .restart local v15    # "numStreamTypes":I
    .restart local v22    # "streamType":I
    :cond_7
    move-object/from16 v0, p0
    ...
    invoke-static {v2, v3, v4}, Landroid/media/AudioService;->access$6600(Landroid/media/AudioService;IZ)V
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$6900(Landroid/media/AudioService;)V
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7300(Landroid/media/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7400(Landroid/media/AudioService;)Z
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7500(Landroid/media/AudioService;)Landroid/hardware/hdmi/HdmiControlManager;
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7600(Landroid/media/AudioService;)Landroid/hardware/hdmi/HdmiTvClient;
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$7700(Landroid/media/AudioService;)Z
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7800(Landroid/media/AudioService;)Ljava/util/HashMap;
    ...
    check-cast v17, Landroid/media/AudioService$AudioPolicyProxy;

    .line 4883
    .local v17, "policy":Landroid/media/AudioService$AudioPolicyProxy;
    invoke-virtual/range {v17 .. v17}, Landroid/media/AudioService$AudioPolicyProxy;->connectMixes()V

    goto :goto_7

    .line 4885
    .end local v12    # "i$":Ljava/util/Iterator;
    .end local v17    # "policy":Landroid/media/AudioService$AudioPolicyProxy;
    :catchall_1
    move-exception v2
    ...
    check-cast v18, Landroid/media/AudioService$LoadSoundEffectReply;

    .line 4901
    .local v18, "reply":Landroid/media/AudioService$LoadSoundEffectReply;
    monitor-enter v18
    ...
    .line 4909
    .end local v13    # "loaded":Z
    .end local v18    # "reply":Landroid/media/AudioService$LoadSoundEffectReply;
    :sswitch_a
    move-object/from16 v0, p1
    ...
    invoke-static {v4, v2}, Landroid/media/AudioService;->access$7900(Landroid/media/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v5, v2}, Landroid/media/AudioService;->access$8100(Landroid/media/AudioService;IILjava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$8200(Landroid/media/AudioService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v3, v2, v4}, Landroid/media/AudioService;->access$8300(Landroid/media/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    .line 4948
    :try_start_c
    new-instance v19, Landroid/media/AudioRoutesInfo;
    ...
    .line 4949
    .local v19, "routes":Landroid/media/AudioRoutesInfo;
    monitor-exit v3
    :try_end_c
    ...
    check-cast v16, Landroid/media/IAudioRoutesObserver;

    .line 4954
    .local v16, "obs":Landroid/media/IAudioRoutesObserver;
    :try_start_d
    ...
    .line 4949
    .end local v16    # "obs":Landroid/media/IAudioRoutesObserver;
    .end local v19    # "routes":Landroid/media/AudioRoutesInfo;
    :catchall_7
    move-exception v2
    ...
    invoke-static {v3, v2}, Landroid/media/AudioService;->access$8700(Landroid/media/AudioService;Z)V
    ...
    invoke-static {v2, v3}, Landroid/media/AudioService;->access$8800(Landroid/media/AudioService;I)V
    ...
    const-string/jumbo v3, "mToast msg can not adjust stream volume in silent mode!"
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$8900(Landroid/media/AudioService;)Landroid/widget/Toast;
    ...
    const-string v3, "MSG_MUTE_MUSIC "
    ...
    # invokes: Landroid/media/AudioService;->getDeviceForStream(I)I
    invoke-static {v4, v5}, Landroid/media/AudioService;->access$4600(Landroid/media/AudioService;I)I
    ...
    const-string v3, "MSG_MUTE_MUSIC completed"
    ...
    const-string/jumbo v3, "music_volume_persistence"
    ...
    const-string/jumbo v4, "music_volume_persistence completed"
    ...
    invoke-static {v2, v3, v14, v4}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

...
.method private requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/LocationListener;Landroid/os/Looper;Landroid/app/PendingIntent;)V
    ...
    .line 937
    const-string v2, "LocationManager|requestLocationUpdates|--end"
...
.method public addGpsStatusListener(Landroid/location/GpsStatus$Listener;)Z
    ...
    .line 1599
    const-string v1, "LocationManager|addGpsStatusListener|--end"
...
.method public addNmeaListener(Landroid/location/GpsStatus$NmeaListener;)Z
    ...
    .line 1651
    const-string v1, "LocationManager|addNmeaListener|--end"
    ...
    .end local v1    # "paras":Ljava/lang/String;
    :cond_0
    iget-object v4, p0, Landroid/location/LocationManager;->mNmeaListeners:Ljava/util/HashMap;
    ...
    invoke-direct {v3, p0, p1}, Landroid/location/LocationManager$GpsStatusListenerTransport;-><init>(Landroid/location/LocationManager;Landroid/location/GpsStatus$NmeaListener;)V
...
.method public addProximityAlert(DDFJLandroid/app/PendingIntent;)V
    ...
    .line 1050
    const-string v2, "LocationManager|addProximityAlert|--end"
    ...
    invoke-virtual {v4, p6, p7}, Landroid/location/LocationRequest;->setExpireIn(J)Landroid/location/LocationRequest;
    ...
    invoke-interface {v4, v3, v1, p8, v5}, Landroid/location/ILocationManager;->requestGeofence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getBestProvider(Landroid/location/Criteria;Z)Ljava/lang/String;
    ...
    .line 449
    const-string v1, "LocationManager|getBestProvider|--end"
...
.method public getLastKnownLocation(Ljava/lang/String;)Landroid/location/Location;
    ...
    const-string v5, "LocationManager|getLastKnownLocation|provider,"
    ...
    invoke-interface {v4, v3, v1}, Landroid/location/ILocationManager;->getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getProvider(Ljava/lang/String;)Landroid/location/LocationProvider;
    ...
    invoke-static {v3, v5}, Landroid/util/SeempJavaFilter;->check(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    const-string v5, "LocationManager|getProvider|name,"
    ...
    :cond_2
    invoke-direct {p0, p1, v2}, Landroid/location/LocationManager;->createProvider(Ljava/lang/String;Lcom/android/internal/location/ProviderProperties;)Landroid/location/LocationProvider;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getProviders(Landroid/location/Criteria;Z)Ljava/util/List;
    ...
    .line 411
    const-string v1, "LocationManager|getProviders|--end"
...
.method public getProviders(Z)Ljava/util/List;
    ...
    invoke-interface {v3, v4, p1}, Landroid/location/ILocationManager;->getProviders(Landroid/location/Criteria;Z)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isProviderEnabled(Ljava/lang/String;)Z
    ...
    const-string v3, "isProviderEnabled"
    ...
    const-string v3, "LocationManager|isProviderEnabled|provider,"
    ...
    invoke-interface {v2, p1}, Landroid/location/ILocationManager;->isProviderEnabled(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public requestLocationUpdates(JFLandroid/location/Criteria;Landroid/app/PendingIntent;)V
    ...
    const-string v0, "LocationManager|requestLocationUpdates|--end"
    ...
    invoke-static {p4, p1, p2, p3, v2}, Landroid/location/LocationRequest;->createFromDeprecatedCriteria(Landroid/location/Criteria;JFZ)Landroid/location/LocationRequest;
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/app/PendingIntent;)V
    ...
    .line 918
    invoke-direct {p0, p1, v3, v3, p2}, Landroid/location/LocationManager;->requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/LocationListener;Landroid/os/Looper;Landroid/app/PendingIntent;)V
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/LocationListener;Landroid/os/Looper;)V
    ...
    invoke-direct {p0, p1, p2, p3, v1}, Landroid/location/LocationManager;->requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/LocationListener;Landroid/os/Looper;Landroid/app/PendingIntent;)V
...
.method public requestLocationUpdates(Ljava/lang/String;JFLandroid/app/PendingIntent;)V
    ...
    const-string v3, "LocationManager|requestLocationUpdates|provider,"
    ...
    invoke-static {p1, p2, p3, p4, v2}, Landroid/location/LocationRequest;->createFromDeprecatedProvider(Ljava/lang/String;JFZ)Landroid/location/LocationRequest;
...
.method public sendExtraCommand(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    const-string/jumbo v3, "sendExtraCommand"
    ...
    const-string v3, "LocationManager|sendExtraCommand|provider,"
    ...
    const-string v3, "RemoteException in sendExtraCommand: "

...
.method public loadIcon(Landroid/content/pm/PackageManager;)Landroid/graphics/drawable/Drawable;
    ...
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "Changwei.Li@Plf.SDK : Modify for we can make ConvertIcon Useless"
...
.method public loadIcon(Landroid/content/pm/PackageManager;Z)Landroid/graphics/drawable/Drawable;
    .locals 2
    .param p1, "pm"    # Landroid/content/pm/PackageManager;
    .param p2, "isConvertEnable"    # Z
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_METHOD:Landroid/annotation/OppoHook$OppoHookType;
        note = "Changwei.Li@Plf.SDK : Add for we can make ConvertIcon Useless"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    invoke-virtual {p1, p0, v0, v1}, Landroid/content/pm/PackageManager;->loadItemIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;Z)Landroid/graphics/drawable/Drawable;

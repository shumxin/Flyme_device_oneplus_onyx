...
.method public call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string v16, "Requested authority "
    ...
    const-string v16, " doesn\'t match provider "
    ...
    .line 667
    .local v12, "out":Landroid/os/Bundle;
    :try_start_0
    const-string v14, "android:createDocument"
    ...
    invoke-virtual {v0, v5, v14}, Landroid/provider/DocumentsProvider;->enforceWritePermissionInner(Landroid/net/Uri;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v4, v8, v3}, Landroid/provider/DocumentsProvider;->createDocument(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    :try_start_1
    const-string v14, "android:renameDocument"
    ...
    invoke-virtual {v0, v4, v3}, Landroid/provider/DocumentsProvider;->renameDocument(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    .line 687
    .restart local v10    # "newDocumentId":Ljava/lang/String;
    if-eqz v10, :cond_0
    ...
    .line 693
    .restart local v11    # "newDocumentUri":Landroid/net/Uri;
    ...
    invoke-virtual {v2, v14, v11, v9}, Landroid/content/Context;->grantUriPermission(Ljava/lang/String;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v0, v4}, Landroid/provider/DocumentsProvider;->revokeDocumentPermission(Ljava/lang/String;)V
    ...
    .end local v11    # "newDocumentUri":Landroid/net/Uri;
    :cond_5
    const-string v14, "android:deleteDocument"
    ...
    invoke-virtual {v0, v4}, Landroid/provider/DocumentsProvider;->deleteDocument(Ljava/lang/String;)V
    ...
    .line 712
    :cond_6
    const-string v14, "android:isChildDocument"
    ...
    invoke-virtual {v0, v4, v3}, Landroid/provider/DocumentsProvider;->isDirectChildDocument(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v12, v14, v7}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V
    ...
    :cond_7
    const-string v14, "android:getPathDocument"
    ...
    invoke-virtual {v0, v4}, Landroid/provider/DocumentsProvider;->getPathDocument(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v16, "Method not supported "

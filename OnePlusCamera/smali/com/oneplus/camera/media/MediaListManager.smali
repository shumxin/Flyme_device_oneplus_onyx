...
.method private static checkMediaLists()V
    ...
    .line 498
    sget-object v38, Lcom/oneplus/camera/media/MediaListManager;->m_Lock:Ljava/lang/Object;
    ...
    .line 502
    .local v31, "removedMedia":Ljava/util/List;, "Ljava/util/List<Lcom/oneplus/camera/media/MediaInfo;>;"
    new-instance v32, Ljava/util/ArrayList;

    invoke-direct/range {v32 .. v32}, Ljava/util/ArrayList;-><init>()V

    .line 505
    .local v32, "replacedMedia":Ljava/util/List;, "Ljava/util/List<Landroid/util/Pair<Lcom/oneplus/camera/media/MediaInfo;Lcom/oneplus/camera/media/MediaInfo;>;>;"
    ...
    .line 508
    .local v33, "srcContentIDs":Ljava/util/Hashtable;, "Ljava/util/Hashtable<Ljava/lang/Integer;Lcom/oneplus/camera/media/MediaInfo;>;"
    :try_start_1
    ...
    .line 511
    .local v28, "mediaInfo":Lcom/oneplus/camera/media/MediaInfo;
    invoke-virtual/range {v28 .. v28}, Lcom/oneplus/camera/media/MediaInfo;->getContentUri()Landroid/net/Uri;
    ...
    .line 514
    .end local v19    # "i":I
    .end local v28    # "mediaInfo":Lcom/oneplus/camera/media/MediaInfo;
    :catch_0
    move-exception v17
    ...
    .end local v19    # "i":I
    .end local v31    # "removedMedia":Ljava/util/List;, "Ljava/util/List<Lcom/oneplus/camera/media/MediaInfo;>;"
    .end local v32    # "replacedMedia":Ljava/util/List;, "Ljava/util/List<Landroid/util/Pair<Lcom/oneplus/camera/media/MediaInfo;Lcom/oneplus/camera/media/MediaInfo;>;>;"
    .end local v33    # "srcContentIDs":Ljava/util/Hashtable;, "Ljava/util/Hashtable<Ljava/lang/Integer;Lcom/oneplus/camera/media/MediaInfo;>;"
    ...
    .restart local v19    # "i":I
    .restart local v31    # "removedMedia":Ljava/util/List;, "Ljava/util/List<Lcom/oneplus/camera/media/MediaInfo;>;"
    .restart local v32    # "replacedMedia":Ljava/util/List;, "Ljava/util/List<Landroid/util/Pair<Lcom/oneplus/camera/media/MediaInfo;Lcom/oneplus/camera/media/MediaInfo;>;>;"
    .restart local v33    # "srcContentIDs":Ljava/util/Hashtable;, "Ljava/util/Hashtable<Ljava/lang/Integer;Lcom/oneplus/camera/media/MediaInfo;>;"
    ...
    .line 567
    .restart local v28    # "mediaInfo":Lcom/oneplus/camera/media/MediaInfo;
    if-eqz v28, :cond_3
    ...
    .line 592
    .local v27, "media":Lcom/oneplus/camera/media/MediaInfo;
    sget-object v6, Lcom/oneplus/camera/media/MediaListManager;->m_BaseMediaList:Ljava/util/List;
    ...
    check-cast v26, Lcom/oneplus/camera/media/MediaListManager$MediaListImpl;

    .line 600
    .local v26, "list":Lcom/oneplus/camera/media/MediaListManager$MediaListImpl;
    ...
    .line 601
    invoke-virtual/range {v26 .. v27}, Lcom/oneplus/camera/media/MediaListManager$MediaListImpl;->addMedia(Lcom/oneplus/camera/media/MediaInfo;)V
    ...
    .line 596
    .end local v23    # "j":I
    .end local v26    # "list":Lcom/oneplus/camera/media/MediaListManager$MediaListImpl;
    :cond_a
    const-string v6, "MediaListManager"
    ...
    .end local v27    # "media":Lcom/oneplus/camera/media/MediaInfo;
    .end local v34    # "time":J
    :catchall_2
    move-exception v6
    ...
    .restart local v27    # "media":Lcom/oneplus/camera/media/MediaInfo;
    .restart local v34    # "time":J
    :cond_c
    add-int/lit8 v19, v19, -0x1
    ...
    .line 610
    .restart local v26    # "list":Lcom/oneplus/camera/media/MediaListManager$MediaListImpl;
    move-object/from16 v0, v26
...
.method private static refreshMediaLists()V
    ...
    .line 912
    invoke-virtual {v13, v15}, Lcom/oneplus/camera/media/MediaListManager$MediaListImpl;->addMedia(Ljava/util/List;)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_1

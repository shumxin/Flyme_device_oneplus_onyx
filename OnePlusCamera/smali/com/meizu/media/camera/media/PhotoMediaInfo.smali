.class public Lcom/meizu/media/camera/media/PhotoMediaInfo;
.super Lcom/meizu/media/camera/media/MediaInfo;
...
.method public constructor <init>(Landroid/net/Uri;Landroid/database/Cursor;)V
    ...
    invoke-direct {p0, v4, p2}, Lcom/meizu/media/camera/media/MediaInfo;-><init>(Landroid/net/Uri;Landroid/database/Cursor;)V
    ...
    iput v4, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_Orientation:I
    ...
    iput-wide v4, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_TakenTime:J

    .line 103
    :goto_0
    invoke-super {p0}, Lcom/meizu/media/camera/media/MediaInfo;->getWidth()I

    move-result v3

    .line 104
    .local v3, "width":I
    invoke-super {p0}, Lcom/meizu/media/camera/media/MediaInfo;->getHeight()I
    ...
    :cond_0
    invoke-super {p0}, Lcom/meizu/media/camera/media/MediaInfo;->getFilePath()Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    iput v3, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_ActualWidth:I

    .line 121
    iput v1, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_ActualHeight:I
    ...
    :cond_2
    iput v5, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_Orientation:I

    .line 99
    iput-wide v6, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_TakenTime:J
...
.method private toDouble(Ljava/lang/String;)Ljava/lang/Double;
    ...
    invoke-direct {p0, p1, v3}, Lcom/meizu/media/camera/media/PhotoMediaInfo;->toRational(Ljava/lang/String;Z)Landroid/util/Rational;
...
.method private toRationals(Ljava/lang/String;Z)[Landroid/util/Rational;
    ...
    invoke-direct {p0, v5, p2}, Lcom/meizu/media/camera/media/PhotoMediaInfo;->toRational(Ljava/lang/String;Z)Landroid/util/Rational;
...
.method public getDetails(Landroid/content/Context;)Ljava/util/Map;
    ...
    .prologue
    .line 142
    invoke-super {p0, p1}, Lcom/meizu/media/camera/media/MediaInfo;->getDetails(Landroid/content/Context;)Ljava/util/Map;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/meizu/media/camera/media/PhotoMediaInfo;->hasFilePath()Z
    ...
    .line 152
    :try_start_0
    invoke-virtual {p0}, Lcom/meizu/media/camera/media/PhotoMediaInfo;->getFilePath()Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v3, v4}, Lcom/meizu/media/camera/media/PhotoMediaInfo;->addToDetails(Ljava/util/Map;Ljava/lang/String;Ljava/lang/Object;)Z
...
.method public getHeight()I
    ...
    .prologue
    .line 177
    iget v0, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_Orientation:I

    sparse-switch v0, :sswitch_data_0

    .line 183
    iget v0, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_ActualHeight:I
    ...
    .line 181
    :sswitch_0
    iget v0, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_ActualWidth:I
...
.method public getTakenTime()J
    ...
    .prologue
    .line 202
    iget-wide v0, p0, Lcom/meizu/media/camera/media/PhotoMediaInfo;->m_TakenTime:J

.class public abstract Lcom/meizu/media/camera/media/DefaultResolutionSelector;
.super Ljava/lang/Object;
.source "DefaultResolutionSelector.java"

# interfaces
.implements Lcom/meizu/media/camera/media/ResolutionSelector;
...
.method protected constructor <init>(Lcom/meizu/media/camera/CameraActivity;)V
    ...
    iput-object v0, p0, Lcom/meizu/media/camera/media/DefaultResolutionSelector;->TAG:Ljava/lang/String;
    ...
    .line 40
    :cond_0
    iput-object p1, p0, Lcom/meizu/media/camera/media/DefaultResolutionSelector;->m_CameraActivity:Lcom/meizu/media/camera/CameraActivity;
...
.method public final getCameraActivity()Lcom/meizu/media/camera/CameraActivity;
    ...
    .prologue
    .line 50
    iget-object v0, p0, Lcom/meizu/media/camera/media/DefaultResolutionSelector;->m_CameraActivity:Lcom/meizu/media/camera/CameraActivity;
...
.method public selectPreviewSize(Lcom/meizu/media/camera/Camera;Lcom/oneplus/base/Settings;Landroid/util/Size;Lcom/meizu/media/camera/media/Resolution;)Landroid/util/Size;
    ...
    .prologue
    .line 59
    invoke-virtual/range {p4 .. p4}, Lcom/meizu/media/camera/media/Resolution;->getAspectRatio()Lcom/oneplus/util/AspectRatio;
    ...
    invoke-virtual/range {p4 .. p4}, Lcom/meizu/media/camera/media/Resolution;->getWidth()I
    ...
    invoke-virtual/range {p4 .. p4}, Lcom/meizu/media/camera/media/Resolution;->getHeight()I
    ...
    sget-object v10, Lcom/meizu/media/camera/Camera;->PROP_PREVIEW_SIZES:Lcom/oneplus/base/PropertyKey;

    invoke-interface {p1, v10}, Lcom/meizu/media/camera/Camera;->get(Lcom/oneplus/base/PropertyKey;)Ljava/lang/Object;
    ...
    .line 105
    :cond_a
    iget-object v10, p0, Lcom/meizu/media/camera/media/DefaultResolutionSelector;->TAG:Ljava/lang/String;
...
.method protected final selectResolutions(Lcom/meizu/media/camera/Camera;Lcom/oneplus/base/Settings;[Lcom/oneplus/util/AspectRatio;ILcom/meizu/media/camera/media/ResolutionSelector$Restriction;)Ljava/util/List;
    .locals 9
    .param p1, "camera"    # Lcom/meizu/media/camera/Camera;
    .param p2, "settings"    # Lcom/oneplus/base/Settings;
    ...
    sget-object v7, Lcom/meizu/media/camera/Camera;->PROP_PICTURE_SIZES:Lcom/oneplus/base/PropertyKey;
    ...
    invoke-static {p5, v6}, Lcom/meizu/media/camera/media/ResolutionSelector$Restriction;->match(Lcom/meizu/media/camera/media/ResolutionSelector$Restriction;Landroid/util/Size;)Z
    ...
    .line 132
    new-instance v7, Lcom/meizu/media/camera/media/Resolution;

    sget-object v8, Lcom/meizu/media/camera/media/MediaType;->PHOTO:Lcom/meizu/media/camera/media/MediaType;

    invoke-direct {v7, v8, v6}, Lcom/meizu/media/camera/media/Resolution;-><init>(Lcom/meizu/media/camera/media/MediaType;Landroid/util/Size;)V

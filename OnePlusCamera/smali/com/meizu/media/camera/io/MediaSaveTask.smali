.class public abstract Lcom/meizu/media/camera/io/MediaSaveTask;
...
.field private volatile m_LensFacing:Lcom/meizu/media/camera/Camera$LensFacing;
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->TAG:Ljava/lang/String;

    .line 49
    iput-object p1, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_Context:Landroid/content/Context;

    .line 50
    return-void
.end method

.method protected constructor <init>(Landroid/content/Context;Lcom/meizu/media/camera/CaptureHandle;)V
    .locals 0
    .param p1, "context"    # Landroid/content/Context;
    ...
    .prologue
    .line 59
    invoke-direct {p0, p1}, Lcom/meizu/media/camera/io/MediaSaveTask;-><init>(Landroid/content/Context;)V

    .line 60
    iput-object p2, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_CaptureHandle:Lcom/meizu/media/camera/CaptureHandle;
...
.method public final getCaptureHandle()Lcom/meizu/media/camera/CaptureHandle;
    ...
    .prologue
    .line 70
    iget-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_CaptureHandle:Lcom/meizu/media/camera/CaptureHandle;
...
.method public final getContentUri()Landroid/net/Uri;
    ...
    .prologue
    .line 80
    iget-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_ContentUri:Landroid/net/Uri;
...
.method protected getDcimPath()Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Lcom/meizu/media/camera/CameraApplication;->findComponent(Ljava/lang/Class;)Lcom/oneplus/base/component/Component;
    ...
    iget-object v3, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_StorageType:Lcom/oneplus/io/Storage$Type;
...
.method public final declared-synchronized getFilePath()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_FilePath:Ljava/lang/String;

    if-nez v0, :cond_0

    .line 107
    invoke-virtual {p0}, Lcom/meizu/media/camera/io/MediaSaveTask;->onGenerateFilePath()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_FilePath:Ljava/lang/String;
...
.method public getLensFacing()Lcom/meizu/media/camera/Camera$LensFacing;
    .locals 1

    .prologue
    .line 118
    iget-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_LensFacing:Lcom/meizu/media/camera/Camera$LensFacing;
...
.method public getLocation()Landroid/location/Location;
    ...
    .prologue
    .line 128
    iget-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_Location:Landroid/location/Location;
...
.method public getStorageType()Lcom/oneplus/io/Storage$Type;
    ...
    .prologue
    .line 145
    iget-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_StorageType:Lcom/oneplus/io/Storage$Type;
...
.method public getThumbnail()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 154
    iget-object v0, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_Thumbnail:Landroid/graphics/Bitmap;
...
.method public final insertToMediaStore()Z
    ...
    .line 164
    iget-object v5, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_FilePath:Ljava/lang/String;

    if-nez v5, :cond_0

    .line 166
    iget-object v5, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {p0, v5, v3}, Lcom/meizu/media/camera/io/MediaSaveTask;->onPrepareMediaStoreValues(Ljava/lang/String;Landroid/content/ContentValues;)Z
    ...
    invoke-virtual {p0, v5, v3}, Lcom/meizu/media/camera/io/MediaSaveTask;->onInsertToMediaStore(Ljava/lang/String;Landroid/content/ContentValues;)Landroid/net/Uri;

    move-result-object v5

    iput-object v5, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_ContentUri:Landroid/net/Uri;

    .line 190
    iget-object v5, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_ContentUri:Landroid/net/Uri;
    ...
    iget-object v7, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_ContentUri:Landroid/net/Uri;
    ...
    iget-object v4, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_FilePath:Ljava/lang/String;

    iget-object v5, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_ContentUri:Landroid/net/Uri;

    invoke-virtual {p0, v4, v5, v1}, Lcom/meizu/media/camera/io/MediaSaveTask;->onPrepareGalleryDatabaseValues(Ljava/lang/String;Landroid/net/Uri;Landroid/content/ContentValues;)Z
    ...
    invoke-virtual {p0, v4, v5, v1}, Lcom/meizu/media/camera/io/MediaSaveTask;->onInsertToGalleryDatabase(Ljava/lang/String;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 212
    iget-object v4, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->TAG:Ljava/lang/String;
...
.method protected onInsertToGalleryDatabase(Ljava/lang/String;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    iget-object v2, v0, Lcom/meizu/media/camera/io/MediaSaveTask;->TAG:Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_Context:Landroid/content/Context;
...
.method public final saveMediaToFile()Z
    ...
    .line 341
    :try_start_0
    invoke-virtual {p0}, Lcom/meizu/media/camera/io/MediaSaveTask;->getFilePath()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_FilePath:Ljava/lang/String;

    .line 342
    iget-object v2, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_FilePath:Ljava/lang/String;

    if-eqz v2, :cond_0

    .line 343
    iget-object v2, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lcom/meizu/media/camera/io/MediaSaveTask;->onPrepareFileSave(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/meizu/media/camera/io/MediaSaveTask;->onSaveToFile(Ljava/lang/String;)Z
...
.method public setLensFacing(Lcom/meizu/media/camera/Camera$LensFacing;)V
    .locals 0
    .param p1, "lensFacing"    # Lcom/meizu/media/camera/Camera$LensFacing;

    .prologue
    .line 400
    iput-object p1, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_LensFacing:Lcom/meizu/media/camera/Camera$LensFacing;
...
.method public setLocation(Landroid/location/Location;)V
    ...
    .prologue
    .line 410
    iput-object p1, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_Location:Landroid/location/Location;
...
.method public setStorageType(Lcom/oneplus/io/Storage$Type;)V
    ...
    .prologue
    .line 420
    iput-object p1, p0, Lcom/meizu/media/camera/io/MediaSaveTask;->m_StorageType:Lcom/oneplus/io/Storage$Type;

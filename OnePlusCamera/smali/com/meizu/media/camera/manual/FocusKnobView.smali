.class public Lcom/meizu/media/camera/manual/FocusKnobView;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/meizu/media/camera/manual/FocusKnobView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected onSetupIcons()Z
    ...
    .prologue
    .line 34
    invoke-virtual/range {p0 .. p0}, Lcom/meizu/media/camera/manual/FocusKnobView;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v0, v1}, Lcom/meizu/media/camera/manual/FocusKnobView;->setIconPadding(I)V
    ...
    .line 46
    .local v21, "items":Ljava/util/List;, "Ljava/util/List<Lcom/meizu/media/camera/manual/KnobItemInfo;>;"
    sget-object v2, Lcom/meizu/media/camera/Camera;->PROP_FOCUS_RANGE:Lcom/oneplus/base/PropertyKey;
    ...
    .line 59
    sget-object v2, Lcom/meizu/media/camera/manual/FocusKnobView;->SELECTED_STATE_SET:[I
    ...
    .line 63
    sget-object v2, Lcom/meizu/media/camera/Camera;->PROP_FOCUS_STEP:Lcom/oneplus/base/PropertyKey;
    ...
    invoke-virtual {v0, v2}, Lcom/meizu/media/camera/manual/FocusKnobView;->setDashAroundAutoEnabled(Z)V
    ...
    new-instance v7, Lcom/meizu/media/camera/manual/KnobInfo;
    ...
    invoke-direct/range {v7 .. v12}, Lcom/meizu/media/camera/manual/KnobInfo;-><init>(IIIII)V

    move-object/from16 v0, p0

    invoke-virtual {v0, v7}, Lcom/meizu/media/camera/manual/FocusKnobView;->setKnobInfo(Lcom/meizu/media/camera/manual/KnobInfo;)V
    ...
    invoke-virtual {v0, v1}, Lcom/meizu/media/camera/manual/FocusKnobView;->setKnobItems(Ljava/util/List;)V

    .line 99
    invoke-virtual/range {p0 .. p0}, Lcom/meizu/media/camera/manual/FocusKnobView;->invalidate()V
